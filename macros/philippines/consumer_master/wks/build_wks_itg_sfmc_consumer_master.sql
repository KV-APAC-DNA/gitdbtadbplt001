{% macro build_wks_itg_sfmc_consumer_master(filename) %}
    {{ log("-----------------------------------------------------------------------------------------------") }}
    ...
    {% if target.name=='prod' %}
                    phlwks_integration.wks_itg_sfmc_consumer_master
                {% else %}
                    {{schema}}.phlwks_integration__wks_itg_sfmc_consumer_master
                {% endif %}
    as(
    ...
    {{ log("-----------------------------------------------------------------------------------------------") }}
    {% do run_query(delete_from_wks_itg_query) %}
    {{ log("-----------------------------------------------------------------------------------------------") }}
    {{ log("Completed  deleting records if there is no change in itg table") }}
    {{ log("-----------------------------------------------------------------------------------------------") }}
{% endmacro %}