...
final as(
    select 
       ...
       coalesce(try_to_date(valid_from,'DD-MM-YYYY')::varchar(10), try_to_date(valid_from,'dd/mm/yy'))::varchar(10) as valid_from,
       coalesce(try_to_date(valid_to,'DD-MM-YYYY')::varchar(10), try_to_date(valid_to,'dd/mm/yy'))::varchar(10) as valid_to,
