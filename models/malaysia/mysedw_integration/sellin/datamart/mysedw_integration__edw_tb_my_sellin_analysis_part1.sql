...
ds_primary as (
    SELECT 'Primary' AS data_src,
                            ...
                            veocurd.exch_rate,
                            trunc(((veossf.base_val * veocurd.exch_rate))::number(20, 8),4) AS base_val,
                            trunc((veossf.sls_qty)::number(20, 8),4) AS sls_qty,
                            trunc((veossf.ret_qty)::number(20, 8),4) AS ret_qty,
                            trunc((veossf.sls_less_rtn_qty)::number(20, 8),4) AS sls_less_rtn_qty,
                            trunc(((veossf.gts_val * veocurd.exch_rate))::number(20, 8),4) AS gts_val,
                            trunc(((veossf.ret_val * veocurd.exch_rate))::number(20, 8),4) AS ret_val,
                            trunc(((veossf.gts_less_rtn_val * veocurd.exch_rate))::number(20, 8),4) AS gts_less_rtn_val,
                            trunc(((veossf.trdng_term_val * veocurd.exch_rate))::number(20, 8),4) AS trdng_term_val,
                            trunc(((veossf.tp_val * veocurd.exch_rate))::number(20, 8),4) AS tp_val,
                            trunc(((veossf.trde_prmtn_val * veocurd.exch_rate))::number(20, 8),4) AS trde_prmtn_val,
                            trunc(((veossf.nts_val * veocurd.exch_rate))::number(20, 8),4) AS nts_val,
                            trunc((veossf.nts_qty)::number(20, 8),4) AS nts_qty,
                            NULL AS po_num,
                            NULL AS sls_doc_num,
                                ...
                                (
                                    (
                                        (
                                            (
                                                (
                                                    edw_tb_my_sellin_analysis_primarynull_source
                                                ) veossf
                                                LEFT JOIN (
