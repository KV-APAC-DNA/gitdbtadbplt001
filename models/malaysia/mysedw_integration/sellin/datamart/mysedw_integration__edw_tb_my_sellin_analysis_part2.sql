...
edw_tb_my_sellin_analysis_primarynull_final as (
    select * from {{ ref('mysedw_integration__edw_tb_my_sellin_analysis_primarynull_final') }}
),
...
transformed as (
    select * from edw_tb_my_sellin_analysis_primarynull_final
    union all
