with source as(
    select * from {{ ref('mysedw_integration__edw_vw_my_siso_analysis') }}
),
final as(
    ...
    region_nm::varchar(20) as region_nm,
    ...
    billing_grs_trd_sls::number(38,13) as billing_grs_trd_sls,
    billing_subtot2::number(38,13) as billing_subtot2,
    billing_subtot3::number(38,13) as billing_subtot3,
    billing_subtot4::number(38,13) as billing_subtot4,
    billing_net_amt::number(38,13) as billing_net_amt,
    billing_est_nts::number(38,13) as billing_est_nts,
    billing_invoice_val::number(38,13) as billing_invoice_val,
    billing_gross_val::number(38,13) as billing_gross_val,
    in_transit_val::number(38,13) as in_transit_val,
    trgt_val::number(36,11) as trgt_val,
    warehse_cd::varchar(50) as warehse_cd,
    end_stock_qty::number(38,4) as end_stock_qty,
    end_stock_val_raw::number(38,9) as end_stock_val_raw,
