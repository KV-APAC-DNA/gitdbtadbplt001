...
final as(
	select 
		...
		coalesce(customer,'')::varchar(30) as customer,
		coalesce(cust_sales,'')::varchar(30) as cust_sales,
		coalesce(distr_chan,'')::varchar(6) as distr_chan,
		fiscper::varchar(21) as fiscper,
		fiscvarnt::varchar(6) as fiscvarnt,
        coalesce(material,'')::varchar(54) as material,
        obj_curr::varchar(15) as obj_curr,
    	recordtp::varchar(3) as recordtp,
    	coalesce(sales_grp,'')::varchar(9) as sales_grp,
