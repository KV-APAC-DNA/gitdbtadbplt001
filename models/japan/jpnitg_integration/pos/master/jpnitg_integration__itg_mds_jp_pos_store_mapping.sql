with source as (
    select * from {{ source('jpnsdl_raw', 'sdl_mds_jp_pos_store_mapping') }}
),
...
result as (
    select 
	    ...
	    store_key_1::varchar(200) as store_key_1,
	    store_key_2::varchar(200) as store_key_2,
	    account_key::varchar(200) as account_key,
	    planet_store_code::number(28,0) as planet_store_code,
	    sales_cat_1::varchar(200) as sales_cat_1,
	    sales_cat_2::varchar(200) as sales_cat_2,
