...
AS (
	SELECT *
	FROM DEV_DNA_CORE.SNAPJPDCLEDW_INTEGRATION.cim24itbun
	),
cim03item_zaiko
AS (
	SELECT *
...
AS (
	SELECT *
	FROM DEV_DNA_CORE.SNAPJPDCLEDW_INTEGRATION.item_data_mart_mv
	),
"wqtm07属性未設定名称マスタ"
AS (
	SELECT *
...
AS (
	SELECT *
	FROM DEV_DNA_CORE.snapjpdclitg_integration.ssmthdclthanjuchhedda
	),
ssmtbsalmei
AS (
	SELECT *
	FROM DEV_DNA_CORE.snapjpdclitg_integration.ssmtbsalmei
	),
tbecitem
AS (
	SELECT *
