            ...
            (
                (
                    (
                        ...
                        AND (bom.validfrom <= to_date(convert_timezone('Asia/Singapore'::TEXT, current_timestamp()::TIMESTAMP without TIME zone)))
                        )
                    AND (bom.validto >= to_date(convert_timezone('Asia/Singapore'::TEXT, current_timestamp()::TIMESTAMP without TIME zone)))
                    )
                AND (bom.validfrom_zvlfromc <= to_date(convert_timezone('Asia/Singapore'::TEXT, current_timestamp()::TIMESTAMP without TIME zone)))
                )
            AND (bom.validto_zvltoi >= to_date(convert_timezone('Asia/Singapore'::TEXT, current_timestamp()::TIMESTAMP without TIME zone)))
            )
    ) base1
WHERE (
        (
