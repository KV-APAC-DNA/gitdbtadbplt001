...
as
(
    SELECT * FROM SNAPJPDCLEDW_INTEGRATION.CIY80SALEH_IKOU
),
CIT80SALEH_IKOU AS
(
    SELECT * FROM SNAPJPDCLEDW_INTEGRATION.CIT80SALEH_IKOU
),
WORK_BIOPTRON AS
(
    SELECT * FROM SNAPJPDCLEDW_INTEGRATION.WORK_BIOPTRON
),
CIM01KOKYA
as
(
