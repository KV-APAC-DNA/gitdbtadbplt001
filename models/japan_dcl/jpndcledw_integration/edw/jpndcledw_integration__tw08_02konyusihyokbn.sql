with tw08_01konyujisseki as (
    select * from dev_dna_core.snapjpdcledw_integration.tw08_01konyujisseki
),
tm25shihyokubunshikii as (
    select * from dev_dna_core.snapjpdcledw_integration.tm25shihyokubunshikii
),
tw08_01konyujisseki_date as 
(
    select
        *,
...
transformed as (
    ...
    FROM
        TW08_01KONYUJISSEKI f1
    left join tm25shihyokubunshikii w1
        on f1.JUCHUKEIKADAYS between w1.shikiilwr and w1.shikiiupr and w1.shihyocode = 'JR01'
    left join tm25shihyokubunshikii w2
        on f1.KONYUKEIKADAYS between w2.shikiilwr and w2.shikiiupr and w2.shihyocode = 'KR01'
