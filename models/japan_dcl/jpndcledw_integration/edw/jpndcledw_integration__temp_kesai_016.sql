...
kokyano_list AS (
    ...
    WHERE insertdate >= to_char(to_date(CONVERT_TIMEZONE('Asia/Tokyo', current_timestamp()))- 2, 'YYYYMMDD')::number
        OR updatedate >= to_char(to_date(CONVERT_TIMEZONE('Asia/Tokyo', current_timestamp()))- 2, 'YYYYMMDD')::number
