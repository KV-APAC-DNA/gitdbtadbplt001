with edw_cnsc_rpt_retail_excellence_details as (
    select * from {{ source('chnedw_integration','edw_rpt_retail_excellence_cnsc') }}
),
...
total_sales_lm as "total_sales_lm",
total_sales_p3m as "total_sales_p3m",
total_sales_p6m as "total_sales_p6m",
total_sales_p12m as "total_sales_p12m",
total_sales_by_store_lm as "total_sales_by_store_lm",
total_sales_by_store_p3m as "total_sales_by_store_p3m",
total_sales_by_store_p6m as "total_sales_by_store_p6m",
total_sales_by_store_p12m as "total_sales_by_store_p12m",
total_sales_by_sku_lm as "total_sales_by_sku_lm",
total_sales_by_sku_p3m as "total_sales_by_sku_p3m",
total_sales_by_sku_p6m as "total_sales_by_sku_p6m",
total_sales_by_sku_p12m as "total_sales_by_sku_p12m",
store_contribution_lm as "store_contribution_lm",
sku_contribution_lm as "sku_contribution_lm",
size_of_price_lm as "size_of_price_lm",
store_contribution_p3m as "store_contribution_p3m",
sku_contribution_p3m as "sku_contribution_p3m",
size_of_price_p3m as "size_of_price_p3m",
store_contribution_p6m as "store_contribution_p6m",
sku_contribution_p6m as "sku_contribution_p6m",
size_of_price_p6m as "size_of_price_p6m",
store_contribution_p12m as "store_contribution_p12m",
sku_contribution_p12m as "sku_contribution_p12m",
size_of_price_p12m as "size_of_price_p12m",
total_sales_lm_lp as "total_sales_lm_lp",
total_sales_p3m_lp as "total_sales_p3m_lp",
total_sales_p6m_lp as "total_sales_p6m_lp",
total_sales_p12m_lp as "total_sales_p12m_lp",
total_sales_by_store_lm_lp as "total_sales_by_store_lm_lp",
total_sales_by_store_p3m_lp as "total_sales_by_store_p3m_lp",
total_sales_by_store_p6m_lp as "total_sales_by_store_p6m_lp",
total_sales_by_store_p12m_lp as "total_sales_by_store_p12m_lp",
total_sales_by_sku_lm_lp as "total_sales_by_sku_lm_lp",
total_sales_by_sku_p3m_lp as "total_sales_by_sku_p3m_lp",
total_sales_by_sku_p6m_lp as "total_sales_by_sku_p6m_lp",
total_sales_by_sku_p12m_lp as "total_sales_by_sku_p12m_lp",
store_contribution_lm_lp as "store_contribution_lm_lp",
sku_contribution_lm_lp as "sku_contribution_lm_lp",
size_of_price_lm_lp as "size_of_price_lm_lp",
store_contribution_p3m_lp as "store_contribution_p3m_lp",
sku_contribution_p3m_lp as "sku_contribution_p3m_lp",
size_of_price_p3m_lp as "size_of_price_p3m_lp",
store_contribution_p6m_lp as "store_contribution_p6m_lp",
sku_contribution_p6m_lp as "sku_contribution_p6m_lp",
size_of_price_p6m_lp as "size_of_price_p6m_lp",
store_contribution_p12m_lp as "store_contribution_p12m_lp",
sku_contribution_p12m_lp as "sku_contribution_p12m_lp",
...
from edw_cnsc_rpt_retail_excellence_details
)
