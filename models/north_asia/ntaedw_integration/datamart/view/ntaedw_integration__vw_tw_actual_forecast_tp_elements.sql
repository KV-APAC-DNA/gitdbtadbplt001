...
(
    SELECT 
        ...
        ('1'::character varying)::character varying(10) AS bu_version,
        NULL::character varying AS forecast_on_year,
        NULL::character varying AS forecast_on_month,
        ...
        COALESCE(sum(derivedtab1.gts_act), 0::double precision) 
            - COALESCE(sum(derivedtab1.rtn_act), 0::double precision)
            - COALESCE(sum(derivedtab1.hidden_discount_prft_mergin_act), 0::double precision)
            - COALESCE(sum(derivedtab1.hidden_discount_markdown_allowance_act), 0::double precision)
            - COALESCE(sum(derivedtab1.hidden_discount_promotion_act), 0::double precision)
            - COALESCE(sum(derivedtab1.term_and_logistics_others_act), 0::double precision)
            - COALESCE(sum(derivedtab1.cash_dsct_act), 0::double precision)
            - COALESCE(sum(derivedtab1.logistics_fees_act), 0::double precision)
            - COALESCE(sum(derivedtab1.profit_margin_allowance_act), 0::double precision)
            - COALESCE(sum(derivedtab1.pricing_space_others_act), 0::double precision)
            - COALESCE(sum(derivedtab1.sales_allowance_act), 0::double precision)
            - COALESCE(sum(derivedtab1.volume_growth_funds_act), 0::double precision)
        AS gts_act,
        0.0 AS nts_bp_tgt,
                            ...
                            AND (
                                    ...
                                    (
                                        (
                                            (
                                                ...
                                                ) = ('403662'::character varying)::text
                                            )
                                            OR (
                                                ltrim(
                                                    (copa.acct_num)::text,
                                                    ('0'::character varying)::text
                                                ) = ('408005'::character varying)::text
                                            )
                                        )
                                        OR (
                                            ltrim(
                                ...
                                OR (
                                    ltrim(
                                        (copa.acct_num)::text,
                                        ('0'::character varying)::text
                                    ) = ('408049'::character varying)::text
                                )
                            )
                        ) THEN 'display'::character varying
                        WHEN (
                            (
                                (copa.acct_hier_shrt_desc)::text = ('NTS'::character varying)::text
                            )
                            AND (
                                (
                                    ltrim(
                                        (copa.acct_num)::text,
                                        ('0'::character varying)::text
                                    ) = ('408023'::character varying)::text
                                )
                                OR (
                                    ltrim(
                                        (copa.acct_num)::text,
                                        ('0'::character varying)::text
                                    ) = ('408024'::character varying)::text
                                )
                            )
                        ) THEN 'DM'::character varying
                        WHEN (
                            (
                                (copa.acct_hier_shrt_desc)::text = ('NTS'::character varying)::text
                            )
                            AND (
                                                    ...
                                                    (
                                                        (
                                                            ltrim(
                                                                (copa.acct_num)::text,
                                                                ('0'::character varying)::text
                                                            ) = ('403382'::character varying)::text
                                                        )
                                                        OR (
                                                            ltrim(
                                                                (copa.acct_num)::text,
                                                                ('0'::character varying)::text
                                                            ) = ('403781'::character varying)::text
                                                        )
                                                    )
                                                    OR (
                                                        ltrim(
                                ...
                                OR (
                                    ltrim(
                                        (copa.acct_num)::text,
                                        ('0'::character varying)::text
                                    ) = ('404020'::character varying)::text
                                )
                            )
                        ) THEN 'Other Support'::character varying
                        WHEN (
                            (
                                (copa.acct_hier_shrt_desc)::text = ('NTS'::character varying)::text
                            )
                            AND (
                                (
                                    ltrim(
                                        (copa.acct_num)::text,
                                        ('0'::character varying)::text
                                    ) = ('404015'::character varying)::text
                                )
                                OR (
                                    ltrim(
                                        (copa.acct_num)::text,
                                        ('0'::character varying)::text
                                    ) = ('404010'::character varying)::text
                                )
                            )
                        ) THEN 'Price Off'::character varying
                                ...
                                AND (
                                    copa.acct_num IN (
                                        ...
                                        WHERE (
                                                (
                                                    (
                                                        (itg_query_parameters.country_code)::text = 'TW'::text
                                                    )
                                                    AND (
                                                        (itg_query_parameters.parameter_name)::text = 'TP'::text
                                                    )
                                                )
                                                AND (
                                                    (itg_query_parameters.parameter_type)::text = 'GL_Account'::text
                                                )
                                            )
                                    )
                                )
                                    ...
                                    (
                                        ...
                                        FROM 
                                            (
                                                ...
                                                (
                                                    (
                                                        copa.matl_num = ltrim((mat_dim.matl_num)::text,('0'::character varying)::text)
                                                    )
                                                )
                                            )
                                    ) mat
...
(
    SELECT 
        ...
        "temp".crncy_cd,
        "temp".bu_version,
        ("temp".forecast_on_year)::character varying AS forecast_on_year,
        ("temp".forecast_on_month)::character varying AS forecast_on_month,
        "temp".forecast_for_year,
        "temp".forecast_for_mnth,
        "temp".caln_day,
        "temp".sls_grp,
        "temp".channel,
        "temp".sls_ofc,
        "temp".sls_ofc_desc,
        "temp".strategy_customer_hierachy_name,
        "temp".lph_level_6,
        "temp".brand,
        'display'::character varying AS tp_element,
        "temp".gts_bp_tgt,
        (0.0)::double precision AS gts_bu_forecast,
        (0.0)::double precision AS gts,
        (0.0)::double precision AS trading_term_act,
        (0.0)::double precision AS hidden_discnt_act,
        (0.0)::double precision AS rtn_act,
        (0.0)::double precision AS gts_act,
        (0.0)::double precision AS nts_bp_tgt,
        (0.0)::double precision AS nts_bu_forecast,
        (0.0)::double precision AS nts_act,
        (0.0)::double precision AS tp_bp_tgt,
        "temp".display_bu_forecast AS tp_bu_forecast,
    ...
    FROM 
        (
            SELECT 
                'BU_FORECAST'::character varying AS subsource_type,
                ...
                NULL::character varying AS caln_day,
                derivedtab2.sls_grp,
                derivedtab2.channel,
                derivedtab2.sls_ofc,
                ...
                (0.0)::real AS gts_bp_tgt,
                (
                    sum(bfph.pre_sales_before_returns) - COALESCE(sum(bfph.sr), (0)::double precision)
                ) AS gts_bu_forecast,
                (0.0)::real AS gts,
                (0.0)::real AS trading_term_act,
                (0.0)::real AS hidden_discnt_act,
                (0.0)::real AS rtn_act,
                0.0 AS gts_act,
                0.0 AS nts_bp_tgt,
                (
            ...
            FROM 
                (
                            ...
                            (
                                ...
                                FROM (
                                        (
                                            ...
                                            FROM (
                                                    (
                                                        SELECT DISTINCT edw_tw_bu_forecast_sku.sap_code
                                                        FROM edw_tw_bu_forecast_sku
                                                    ) bu
                                                    LEFT JOIN (
                    ...
                    (
                        ...
                        AND bfph.forecast_on_year::character varying::text = derivedtab2.forecast_on_year::text
                        AND ltrim(bfph.forecast_on_month::character varying::text, '0'::character varying::text) = ltrim(derivedtab2.forecast_on_month::text, '0'::character varying::text)
                        AND bfph.forecast_for_year::character varying::text = derivedtab2.forecast_for_year::character varying::text
                        AND bfph.forecast_for_mnth::character varying::text = derivedtab2.forecast_for_mnth::character varying::text
                        AND COALESCE(bfph.lph_level_6, '#'::character varying)::text = COALESCE(derivedtab2.prod_hier_l8::character varying, '#'::character varying)::text
                        AND bfph.channel::text = derivedtab2.channel::text
                        AND bfph.sls_grp::text = derivedtab2.sls_grp::text
                        AND bfph.strategy_customer_hierachy_name::text = derivedtab2.strategy_customer_hierachy_name::text
                    LEFT JOIN v_intrm_crncy_exch crncy ON 
                    (
                        (
    ...
    SELECT 
        ...
        "temp".lph_level_6,
        "temp".brand,
        'Other Support'::character varying AS tp_element,
        (0.0)::double precision AS gts_bp_tgt,
        (0.0)::double precision AS gts_bu_forecast,
        (0.0)::double precision AS gts,
        (0.0)::double precision AS trading_term_act,
        (0.0)::double precision AS hidden_discnt_act,
        ...
        (0.0)::double precision AS nts_act,
        (0.0)::double precision AS tp_bp_tgt,
        "temp".other_support_bu_forecast AS tp_bu_forecast,
        (0.0)::double precision AS tp_act,
        "temp".to_crncy,
        "temp".ex_rt
    FROM 
                ...
                (
                    ...
                    (
                        SELECT 
                            ...
                            (bfph.forecast_for_year)::integer AS forecast_for_year,
                            CASE
                                WHEN bfph.forecast_for_mnth::text = 'Jan'::character varying::text THEN 1
                                WHEN bfph.forecast_for_mnth IS NULL AND 'Jan' IS NULL THEN 1
                                WHEN bfph.forecast_for_mnth::text = 'Feb'::character varying::text THEN 2
                                WHEN bfph.forecast_for_mnth IS NULL AND 'Feb' IS NULL THEN 2
                                WHEN bfph.forecast_for_mnth::text = 'Mar'::character varying::text THEN 3
                                WHEN bfph.forecast_for_mnth IS NULL AND 'Mar' IS NULL THEN 3
                                WHEN bfph.forecast_for_mnth::text = 'Apr'::character varying::text THEN 4
                                WHEN bfph.forecast_for_mnth IS NULL AND 'Apr' IS NULL THEN 4
                                WHEN bfph.forecast_for_mnth::text = 'May'::character varying::text THEN 5
                                WHEN bfph.forecast_for_mnth IS NULL AND 'May' IS NULL THEN 5
                                WHEN bfph.forecast_for_mnth::text = 'Jun'::character varying::text THEN 6
                                WHEN bfph.forecast_for_mnth IS NULL AND 'Jun' IS NULL THEN 6
                                WHEN bfph.forecast_for_mnth::text = 'Jul'::character varying::text THEN 7
                                WHEN bfph.forecast_for_mnth IS NULL AND 'Jul' IS NULL THEN 7
                                WHEN bfph.forecast_for_mnth::text = 'Aug'::character varying::text THEN 8
                                WHEN bfph.forecast_for_mnth IS NULL AND 'Aug' IS NULL THEN 8
                                WHEN bfph.forecast_for_mnth::text = 'Sep'::character varying::text THEN 9
                                WHEN bfph.forecast_for_mnth IS NULL AND 'Sep' IS NULL THEN 9
                                WHEN bfph.forecast_for_mnth::text = 'Oct'::character varying::text THEN 10
                                WHEN bfph.forecast_for_mnth IS NULL AND 'Oct' IS NULL THEN 10
                                WHEN bfph.forecast_for_mnth::text = 'Nov'::character varying::text THEN 11
                                WHEN bfph.forecast_for_mnth IS NULL AND 'Nov' IS NULL THEN 11
                                WHEN bfph.forecast_for_mnth::text = 'Dec'::character varying::text THEN 12
                                WHEN bfph.forecast_for_mnth IS NULL AND 'Dec' IS NULL THEN 12
                                ELSE NULL::integer
                            END AS forecast_for_mnth,
                            bfph.sls_grp,
                            bfph.channel,
    ...
    SELECT 
        ...
        "temp".lph_level_6,
        "temp".brand,
        'Price Off'::character varying AS tp_element,
        (0.0)::double precision AS gts_bp_tgt,
        (0.0)::double precision AS gts_bu_forecast,
        (0.0)::double precision AS gts,
        (0.0)::double precision AS trading_term_act,
        ...
        (0.0)::double precision AS nts_act,
        (0.0)::double precision AS tp_bp_tgt,
        "temp".price_off_bu_forecast AS tp_bu_forecast,
        (0.0)::double precision AS tp_act,
        "temp".to_crncy,
        "temp".ex_rt
    FROM 
                                        ...
                                        (
                                            (
                                                SELECT 
                                                    ...
                                                    (edw_tw_bu_forecast_sku.forecast_for_year)::integer AS forecast_for_year,
                                                    CASE
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Jan'::character varying::text THEN 1
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Jan' IS NULL THEN 1
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Feb'::character varying::text THEN 2
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Feb' IS NULL THEN 2
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Mar'::character varying::text THEN 3
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Mar' IS NULL THEN 3
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Apr'::character varying::text THEN 4
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Apr' IS NULL THEN 4
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'May'::character varying::text THEN 5
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'May' IS NULL THEN 5
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Jun'::character varying::text THEN 6
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Jun' IS NULL THEN 6
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Jul'::character varying::text THEN 7
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Jul' IS NULL THEN 7
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Aug'::character varying::text THEN 8
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Aug' IS NULL THEN 8
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Sep'::character varying::text THEN 9
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Sep' IS NULL THEN 9
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Oct'::character varying::text THEN 10
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Oct' IS NULL THEN 10
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Nov'::character varying::text THEN 11
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Nov' IS NULL THEN 11
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Dec'::character varying::text THEN 12
                                                        WHEN edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Dec' IS NULL THEN 12
                                                        ELSE NULL::integer
                                                    END AS forecast_for_mnth,
                                                    edw_tw_bu_forecast_sku.sls_grp,
                                                    edw_tw_bu_forecast_sku.channel,
    ...
    SELECT 
        ...
        "temp".lph_level_6,
        "temp".brand,
        'DM'::character varying AS tp_element,
        (0.0)::double precision AS gts_bp_tgt,
        (0.0)::double precision AS gts_bu_forecast,
        (0.0)::double precision AS gts,
        (0.0)::double precision AS trading_term_act,
        ...
        (0.0)::double precision AS nts_act,
        (0.0)::double precision AS tp_bp_tgt,
        "temp".dm_bu_forecast AS tp_bu_forecast,
        (0.0)::double precision AS tp_act,
        "temp".to_crncy,
        "temp".ex_rt
    FROM 
        (
            SELECT 'BU_FORECAST'::character varying AS subsource_type,
                'TW'::character varying AS cntry_cd,
                derivedtab2.crncy_cd,
                derivedtab2.bu_version,
                (derivedtab2.forecast_on_year)::integer AS forecast_on_year,
                    ...
                    (
                                            ...
                                            (
                                                (
                                                    SELECT 
                                                        ...
                                                        (edw_tw_bu_forecast_sku.forecast_for_year)::integer AS forecast_for_year,
                                                        CASE
                                                            WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Jan'::character varying::text
                                                                OR (edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Jan' IS NULL) THEN 1
                                                            WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Feb'::character varying::text
                                                                OR (edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Feb' IS NULL) THEN 2
                                                            WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Mar'::character varying::text
                                                                OR (edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Mar' IS NULL) THEN 3
                                                            WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Apr'::character varying::text
                                                                OR (edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Apr' IS NULL) THEN 4
                                                            WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'May'::character varying::text
                                                                OR (edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'May' IS NULL) THEN 5
                                                            WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Jun'::character varying::text
                                                                OR (edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Jun' IS NULL) THEN 6
                                                            WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Jul'::character varying::text
                                                                OR (edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Jul' IS NULL) THEN 7
                                                            WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Aug'::character varying::text
                                                                OR (edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Aug' IS NULL) THEN 8
                                                            WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Sep'::character varying::text
                                                                OR (edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Sep' IS NULL) THEN 9
                                                            WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Oct'::character varying::text
                                                                OR (edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Oct' IS NULL) THEN 10
                                                            WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Nov'::character varying::text
                                                                OR (edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Nov' IS NULL) THEN 11
                                                            WHEN edw_tw_bu_forecast_sku.forecast_for_mnth::text = 'Dec'::character varying::text
                                                                OR (edw_tw_bu_forecast_sku.forecast_for_mnth IS NULL AND 'Dec' IS NULL) THEN 12
                                                            ELSE NULL::integer
                                                        END AS forecast_for_mnth,
                                                        edw_tw_bu_forecast_sku.sls_grp,
                                                        edw_tw_bu_forecast_sku.channel,
                        ...
                        (
                            SELECT 
                                ...
                                (bfph.forecast_for_year)::integer AS forecast_for_year,
                                CASE
                                    WHEN (bfph.forecast_for_mnth)::text = 'Jan'::character varying::text
                                        OR (bfph.forecast_for_mnth IS NULL AND 'Jan' IS NULL) THEN 1
                                    WHEN (bfph.forecast_for_mnth)::text = 'Feb'::character varying::text
                                        OR (bfph.forecast_for_mnth IS NULL AND 'Feb' IS NULL) THEN 2
                                    WHEN (bfph.forecast_for_mnth)::text = 'Mar'::character varying::text
                                        OR (bfph.forecast_for_mnth IS NULL AND 'Mar' IS NULL) THEN 3
                                    WHEN (bfph.forecast_for_mnth)::text = 'Apr'::character varying::text
                                        OR (bfph.forecast_for_mnth IS NULL AND 'Apr' IS NULL) THEN 4
                                    WHEN (bfph.forecast_for_mnth)::text = 'May'::character varying::text
                                        OR (bfph.forecast_for_mnth IS NULL AND 'May' IS NULL) THEN 5
                                    WHEN (bfph.forecast_for_mnth)::text = 'Jun'::character varying::text
                                        OR (bfph.forecast_for_mnth IS NULL AND 'Jun' IS NULL) THEN 6
                                    WHEN (bfph.forecast_for_mnth)::text = 'Jul'::character varying::text
                                        OR (bfph.forecast_for_mnth IS NULL AND 'Jul' IS NULL) THEN 7
                                    WHEN (bfph.forecast_for_mnth)::text = 'Aug'::character varying::text
                                        OR (bfph.forecast_for_mnth IS NULL AND 'Aug' IS NULL) THEN 8
                                    WHEN (bfph.forecast_for_mnth)::text = 'Sep'::character varying::text
                                        OR (bfph.forecast_for_mnth IS NULL AND 'Sep' IS NULL) THEN 9
                                    WHEN (bfph.forecast_for_mnth)::text = 'Oct'::character varying::text
                                        OR (bfph.forecast_for_mnth IS NULL AND 'Oct' IS NULL) THEN 10
                                    WHEN (bfph.forecast_for_mnth)::text = 'Nov'::character varying::text
                                        OR (bfph.forecast_for_mnth IS NULL AND 'Nov' IS NULL) THEN 11
                                    WHEN (bfph.forecast_for_mnth)::text = 'Dec'::character varying::text
                                        OR (bfph.forecast_for_mnth IS NULL AND 'Dec' IS NULL) THEN 12
                                    ELSE NULL::integer
                                END AS forecast_for_mnth,
                                bfph.sls_grp,
                                bfph.channel,
                            ...
                            bfph.bu_version::text = derivedtab2.bu_version::text
                            AND (bfph.forecast_on_year::character varying)::text = derivedtab2.forecast_on_year::text
                            AND ltrim(bfph.forecast_on_month::character varying)::text = ltrim(derivedtab2.forecast_on_month)::text
                            AND (bfph.forecast_for_year::character varying)::text = (derivedtab2.forecast_for_year)::text
                            AND (bfph.forecast_for_mnth::character varying)::text = (derivedtab2.forecast_for_mnth)::text
                            AND COALESCE(bfph.lph_level_6, '#'::character varying)::text = COALESCE(derivedtab2.prod_hier_l8::character varying, '#'::character varying)::text
                            AND bfph.channel::text = derivedtab2.channel::text
                            AND bfph.sls_grp::text = derivedtab2.sls_grp::text
                            AND bfph.strategy_customer_hierachy_name::text = derivedtab2.strategy_customer_hierachy_name::text
    ...
    SELECT 
        ...
        "temp".lph_level_6,
        "temp".brand,
        NULL::character varying AS tp_element,
        (0.0)::double precision AS gts_bp_tgt,
        "temp".gts_bu_forecast,
        (0.0)::double precision AS gts,
        (0.0)::double precision AS trading_term_act,
        (0.0)::double precision AS hidden_discnt_act,
        (0.0)::double precision AS rtn_act,
        (0.0)::double precision AS gts_act,
        (0.0)::double precision AS nts_bp_tgt,
        "temp".nts_bu_forecast,
        (0.0)::double precision AS nts_act,
        (0.0)::double precision AS tp_bp_tgt,
        (0.0)::double precision AS tp_bu_forecast,
        (0.0)::double precision AS tp_act,
        "temp".to_crncy,
        "temp".ex_rt
    FROM 
        ...
        (
            (
                SELECT 'TWD'::character varying AS crncy_cd,
                    ...
                    CASE
                        WHEN bptgt.forecast_for_mnth::text = 'Jan'::character varying::text THEN 1
                        WHEN bptgt.forecast_for_mnth IS NULL AND 'Jan' IS NULL THEN 1
                        WHEN bptgt.forecast_for_mnth::text = 'Feb'::character varying::text THEN 2
                        WHEN bptgt.forecast_for_mnth IS NULL AND 'Feb' IS NULL THEN 2
                        WHEN bptgt.forecast_for_mnth::text = 'Mar'::character varying::text THEN 3
                        WHEN bptgt.forecast_for_mnth IS NULL AND 'Mar' IS NULL THEN 3
                        WHEN bptgt.forecast_for_mnth::text = 'Apr'::character varying::text THEN 4
                        WHEN bptgt.forecast_for_mnth IS NULL AND 'Apr' IS NULL THEN 4
                        WHEN bptgt.forecast_for_mnth::text = 'May'::character varying::text THEN 5
                        WHEN bptgt.forecast_for_mnth IS NULL AND 'May' IS NULL THEN 5
                        WHEN bptgt.forecast_for_mnth::text = 'Jun'::character varying::text THEN 6
                        WHEN bptgt.forecast_for_mnth IS NULL AND 'Jun' IS NULL THEN 6
                        WHEN bptgt.forecast_for_mnth::text = 'Jul'::character varying::text THEN 7
                        WHEN bptgt.forecast_for_mnth IS NULL AND 'Jul' IS NULL THEN 7
                        WHEN bptgt.forecast_for_mnth::text = 'Aug'::character varying::text THEN 8
                        WHEN bptgt.forecast_for_mnth IS NULL AND 'Aug' IS NULL THEN 8
                        WHEN bptgt.forecast_for_mnth::text = 'Sep'::character varying::text THEN 9
                        WHEN bptgt.forecast_for_mnth IS NULL AND 'Sep' IS NULL THEN 9
                        WHEN bptgt.forecast_for_mnth::text = 'Oct'::character varying::text THEN 10
                        WHEN bptgt.forecast_for_mnth IS NULL AND 'Oct' IS NULL THEN 10
                        WHEN bptgt.forecast_for_mnth::text = 'Nov'::character varying::text THEN 11
                        WHEN bptgt.forecast_for_mnth IS NULL AND 'Nov' IS NULL THEN 11
                        WHEN bptgt.forecast_for_mnth::text = 'Dec'::character varying::text THEN 12
                        WHEN bptgt.forecast_for_mnth IS NULL AND 'Dec' IS NULL THEN 12
                        ELSE NULL::integer
                    END AS forecast_for_mnth,
                    bptgt.sls_grp,
                    bptgt.channel,
