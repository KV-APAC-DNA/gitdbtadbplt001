...
(   
    SELECT 
        ...
        a.sls_emp_hist as sls_emp_hist,
        ...
        a.val_type_rpt as val_type_rpt,
        iff(rtrim(a.mercia_ref)='',null,rtrim(a.mercia_ref)) as mercia_ref,
        iff(rtrim(a.caln_day)='',null,rtrim(a.caln_day)) as caln_day,
        a.caln_yr_mo as caln_yr_mo,
        a.fisc_yr as fisc_yr,
        a.pstng_per as pstng_per,
        a.fisc_yr_per as fisc_yr_per,
        ...
        a.fx_amt_cntl_area_crncy as fx_amt_cntl_area_crncy,
        a.amt_cntl_area_crncy as amt_cntl_area_crncy,
        iff(rtrim(a.crncy_key)='',null,rtrim(a.crncy_key)) as crncy_key,
        a.amt_obj_crncy as amt_obj_crncy,
        iff(rtrim(a.obj_crncy_co_obj)='',null,rtrim(a.obj_crncy_co_obj)) as obj_crncy_co_obj,
        a.grs_amt_trans_crncy as grs_amt_trans_crncy,
