...
select * from DEV_DNA_LOAD.SNAPOSESDL_RAW.SDL_MDS_PH_CLOBOTICS_SOS_REF
),
ITG_PH_CLOBOTICS_TASK as (
select * from DEV_DNA_CORE.SNAPOSEITG_INTEGRATION.ITG_PH_CLOBOTICS_TASK
),
ITG_PH_CLOBOTICS_STORE as (
select * from DEV_DNA_CORE.SNAPOSEITG_INTEGRATION.ITG_PH_CLOBOTICS_STORE
),
ITG_PH_CLOBOTICS_SURVEY as (
select * from DEV_DNA_CORE.SNAPOSEITG_INTEGRATION.ITG_PH_CLOBOTICS_SURVEY
),
ITG_MDS_PH_PS_TARGETS as (
select * from DEV_DNA_CORE.SNAPOSEITG_INTEGRATION.ITG_MDS_PH_PS_TARGETS
),
ITG_MDS_PH_PS_WEIGHTS as (
select * from DEV_DNA_CORE.SNAPOSEITG_INTEGRATION.ITG_MDS_PH_PS_WEIGHTS
),
ITG_MDS_PH_GT_CUSTOMER as (
select * from DEV_DNA_CORE.SNAPOSEITG_INTEGRATION.ITG_MDS_PH_GT_CUSTOMER
),
