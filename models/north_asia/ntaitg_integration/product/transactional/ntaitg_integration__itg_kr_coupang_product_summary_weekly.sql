DELETE FROM na_itg.itg_kr_coupang_product_summary_weekly
...
FROM na_sdl.sdl_kr_coupang_product_summary_weekly);


INSERT INTO na_itg.itg_kr_coupang_product_summary_weekly
(
	category_depth1
	,category_depth2
	,category_depth3
