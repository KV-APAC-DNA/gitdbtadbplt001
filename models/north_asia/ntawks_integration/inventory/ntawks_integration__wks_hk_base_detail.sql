...
as (
  select *
  from DEV_DNA_CORE.ALAKSH01_WORKSPACE.ntawks_integration__wks_hk_lastnmonths
  --{{ ref('ntawks_integration__wks_hk_lastnmonths') }}
  ),
edw_vw_os_time_dim
as (
  select *
...
wks_hk_base as (
  select * from DEV_DNA_CORE.ALAKSH01_WORKSPACE.NTAWKS_INTEGRATION__wks_hk_base
