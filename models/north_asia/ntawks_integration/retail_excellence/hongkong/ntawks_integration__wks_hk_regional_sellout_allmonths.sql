...
wks_hk_regional_sellout_allmonths as 
(
...
FROM (SELECT DISTINCT cntry_cd,
      ...
      FROM (SELECT DISTINCT cntry_cd,
                   dim_key,
                   data_source
            FROM WKS_HK_BASE_RETAIL_EXCELLENCE) a,
  ...
  LEFT JOIN WKS_HK_BASE_RETAIL_EXCELLENCE base
...
(
    ...
    from wks_hk_regional_sellout_allmonths
)
