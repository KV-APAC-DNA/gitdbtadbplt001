...
(
    select 
        ...
        item.grp_cd::varchar(10) as grp_cd,
        ...
        item.name1::varchar(500) as product_name1,
        item.name2::varchar(500) as product_name2,
    ...
    left join itg_th_dtsitemmaster item on trim (st.prod_cd) = trim (item.item_cd)
