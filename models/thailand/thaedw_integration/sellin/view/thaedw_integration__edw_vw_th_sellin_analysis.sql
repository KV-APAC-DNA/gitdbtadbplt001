...
sellin_fact as(
    ...
    GROUP BY 
    coalesce(trim(edw_vw_os_sellin_sales_fact.item_cd),''),
    coalesce(trim(edw_vw_os_sellin_sales_fact.cust_id),''),
    coalesce(trim(edw_vw_os_sellin_sales_fact.sls_grp),''),
    coalesce(trim(sls_grp_lkp.sls_grp_desc),''),
    coalesce(trim(edw_vw_os_sellin_sales_fact.sls_ofc),''),
    coalesce(trim(sls_ofc_lkp.sls_ofc_desc),''),
    coalesce(trim(edw_vw_os_sellin_sales_fact.sls_org),''),
    coalesce(trim(edw_vw_os_sellin_sales_fact.plnt),''),
    coalesce(trim(edw_vw_os_sellin_sales_fact.acct_no),''),
    coalesce(trim(edw_vw_os_sellin_sales_fact.dstr_chnl),''),
    coalesce(trim(edw_vw_os_sellin_sales_fact.cust_grp),''),
    coalesce(trim(edw_vw_os_sellin_sales_fact.cust_sls),''),
    coalesce(trim(edw_vw_os_sellin_sales_fact.pstng_per),''),
    coalesce(trim(edw_vw_os_sellin_sales_fact.jj_mnth_id),''),
