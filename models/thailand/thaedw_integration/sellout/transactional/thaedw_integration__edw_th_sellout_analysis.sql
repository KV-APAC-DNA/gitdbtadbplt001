with source as
(
    select * from {{ ref('thaedw_integration__edw_vw_th_sellout_analysis') }}
),
final as
(
    select
        ...
        foc_trd_discnt_item_lvl::number(38,6) as foc_trd_discnt_item_lvl,
        foc_trd_discnt_bill_lvl::number(38,6) as foc_trd_discnt_bill_lvl,
        tot_bf_discount::float as tot_bf_discount,
        foc_net_invc::number(38,6) as foc_net_invc,
        gross_sales::number(38,6) as gross_sales,
