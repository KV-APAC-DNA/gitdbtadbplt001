...
transformation as (
 ...
 DM.FISC_YR,
       ...
       DM.MARKET,
       DM.DATA_SRC,
       UPPER(DM.SELL_OUT_CHANNEL) AS CHANNEL_NAME,
       UPPER(DM.DISTRIBUTOR_CODE) AS DISTRIBUTOR_CODE,
       UPPER(DM.DISTRIBUTOR_NAME) AS DISTRIBUTOR_NAME,
       UPPER(DM.SELL_OUT_CHANNEL) AS SELL_OUT_CHANNEL,
       UPPER(DM.STORE_TYPE) AS STORE_TYPE,
       NULL AS PRIORITIZATION_SEGMENTATION,
       NULL AS STORE_CATEGORY,
       UPPER(DM.STORE_CODE) AS STORE_CODE,
       UPPER(DM.STORE_NAME) AS STORE_NAME,
       NULL AS STORE_GRADE,
       NULL AS STORE_SIZE,
       DM.REGION,
       DM.ZONE_NAME,
       UPPER(DM.SOLDTO_CODE) AS SOLDTO_CODE,
       NULL AS RTRLATITUDE,
       ...
       DM.CUSTOMER_NAME,
       DM.CUSTOMER_CODE,
	   UPPER(COALESCE(DM.PRODUCT_CODE, 'Not Available')) AS PRODUCT_CODE,
       UPPER(COALESCE(DM.PRODUCT_NAME, 'Not Available')) AS PRODUCT_NAME,
       PROD_HIER_L1,
...
product_name::varchar(337) AS product_name,
