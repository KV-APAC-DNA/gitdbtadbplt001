...
SELECT
  ...
  derived_table3.year_month::varchar(14) as year_month,
  to_number(derived_table3."year",18,0) as year,
  to_number(derived_table3."month",18,0) as month,
  ...
  to_number(derived_table3.reactivate_stores_count,38,0) as reactivate_stores_count,
  to_number(derived_table3.inactive_stores_count,38,0) as inactive_stores_count,
  to_number(derived_table3.active_stores_count,38,0) as active_stores_count,
  ...
  coalesce(derived_table3.total_skus,0) as total_skus,
  coalesce(derived_table3.total_stores,0) as total_stores
FROM (
  SELECT
