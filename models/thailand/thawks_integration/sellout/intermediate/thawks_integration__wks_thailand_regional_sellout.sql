...
group by 
  ...
  select 
    ...
    qrtr_no::varchar(16777216) as qrtr_no,
    mnth_id::varchar(16777216) as mnth_id,
    ...
    sap_parent_customer_description::varchar(150) as sap_parent_customer_description,
    sap_customer_channel_key::varchar(12) as sap_customer_channel_key,
    sap_customer_channel_description::varchar(150) as sap_customer_channel_description,
    sap_customer_sub_channel_key::varchar(12) as sap_customer_sub_channel_key,
    sap_sub_channel_description::varchar(150) as sap_sub_channel_description,
    sap_go_to_mdl_key::varchar(12) as sap_go_to_mdl_key,
    sap_go_to_mdl_description::varchar(150) as sap_go_to_mdl_description,
    sap_banner_key::varchar(12) as sap_banner_key,
    sap_banner_description::varchar(150) as sap_banner_description,
    sap_banner_format_key::varchar(12) as sap_banner_format_key,
    sap_banner_format_description::varchar(150) as sap_banner_format_description,
    retail_environment::varchar(50) as retail_environment,
    customer_segment_key::varchar(16777216) as customer_segment_key,
    customer_segment_description::varchar(16777216) as customer_segment_description,
    ...
    crtd_dttm::timestamp_ltz(9) as crtd_dttm,
    updt_dttm::timestamp_ltz(9) as updt_dttm
from transformed
)
select * from final