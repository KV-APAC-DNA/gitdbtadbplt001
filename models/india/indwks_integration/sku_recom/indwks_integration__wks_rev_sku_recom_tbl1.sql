with wks_rev_itg_sku_recom_flag as
(
    select * from {{ ref('indwks_integration__wks_rev_itg_sku_recom_flag') }}
),
...
wks_rev_edw_retailer_dim as
(
    select * from {{ ref('indwks_integration__wks_rev_edw_retailer_dim') }}
),
...
---------------------
FROM wks_rev_itg_sku_recom_flag sku
---------------------
...
--------------------
LEFT JOIN wks_rev_edw_retailer_dim rd
