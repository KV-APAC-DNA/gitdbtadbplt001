...
(
 ...
 (
    select * from {{ ref('indwks_integration__wks_mds_target_final') }}
 ),
edw_rpt_retail_excellence as
(
SELECT CAST(FISC_YR AS INTEGER) AS FISC_YR,
       ...
       DISTRIBUTOR_CODE,
       DISTRIBUTOR_NAME,
       RETAIL_ENVIRONMENT as SELL_OUT_CHANNEL,
       STORE_TYPE,
       ...
       SELL_OUT_CHANNEL as RETAIL_ENVIRONMENT,
...
crt_dttm::timestamp AS crt_dttm
  ...
  from edw_rpt_retail_excellence
)
