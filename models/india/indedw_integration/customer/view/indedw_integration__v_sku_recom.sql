...
(
    select * from inditg_integration.itg_sku_recom_orangestoretarget
),
itg_xdm_salesmanskulinemapping as 
(
    select * from inditg_integration.itg_xdm_salesmanskulinemapping
),
...
itg_udcmaster as 
(
    select * from inditg_integration.itg_udcmaster
),
itg_sku_recom_flag as 
(
    select * from inditg_integration.itg_sku_recom_flag
),
itg_udcdetails as 
(
