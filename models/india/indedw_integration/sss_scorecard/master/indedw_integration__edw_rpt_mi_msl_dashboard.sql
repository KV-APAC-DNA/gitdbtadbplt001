...
wks_mi_msl_agg_tbl as(
    select * from DEV_DNA_CORE.sm05_workspace.INDWKS_INTEGRATION__wks_mi_msl_agg_tbl
),
wks_mi_msl_reco_vs_sold as(
    select * from DEV_DNA_CORE.sm05_workspace.INDWKS_INTEGRATION__wks_mi_msl_reco_vs_sold
),
union1 as(
