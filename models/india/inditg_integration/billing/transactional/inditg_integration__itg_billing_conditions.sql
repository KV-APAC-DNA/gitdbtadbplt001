with source as
(
    select * from {{ source('indsdl_raw', 'sdl_sap_billing_conditions') }}
),
final as
(
    SELECT 
    ltrim(bill_num,'0') as bill_num,
    bill_item,
    bic_zstepnum,
    kncounter,
    ltrim(doc_number,'0') as doc_number,
    s_ord_item,
    knart,
    ch_on,
    comp_code,
    sales_dist,
    bill_type,
    cast(cast(bill_date as varchar(12)) as Date) as  bill_date,
    bill_cat,
    loc_currcy,
    cust_group,
    ltrim(sold_to,'0') as sold_to,
    ltrim(payer,'0') as payer,
    exrate_acc,
    stat_curr,
    doc_categ,
    salesorg,
    ...
    ltrim(mat_entrd,'0') as mat_entrd,
    matl_grp_1,
    matl_grp_2,
    matl_grp_3,
    matl_grp_4,
    matl_grp_5,
    ltrim(billtoprty,'0') as billtoprty,
    ...
    division,
    stat_date,
    ltrim(refer_doc,'0') as refer_doc,
    refer_itm,
    sales_off,
    sales_grp,
    wbs_elemt,
