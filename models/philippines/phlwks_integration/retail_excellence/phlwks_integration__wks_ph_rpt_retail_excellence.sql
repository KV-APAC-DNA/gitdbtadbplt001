...
(
    ...
    FROM ( SELECT TARGET.FISC_YR,		--// FROM ( SELECT TARGET.FISC_YR,
                ...
                COALESCE(TARGET.SELL_OUT_CHANNEL, ACTUAL.CHANNEL) AS SELL_OUT_CHANNEL,		--//              TARGET.SELL_OUT_CHANNEL AS SELL_OUT_CHANNEL,
...
(
    ...
    FROM (SELECT CAST(ACTUAL.YEAR AS numeric(18,0) ) AS YEAR,		--// INTEGER // FROM (SELECT CAST(ACTUAL.YEAR AS numeric(18,0) ) AS YEAR,
                ...
                COALESCE(STORE_DET.SELL_OUT_CHANNEL, ACTUAL.CHANNEL) AS SELL_OUT_CHANNEL,		--//              STORE_DET.SELL_OUT_CHANNEL AS SELL_OUT_CHANNEL,
