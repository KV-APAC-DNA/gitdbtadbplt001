...
(
    select * from {{ ref('phledw_integration__edw_vw_ph_sfmc_consumer_master') }}
),
...
(
    select * from select * from {{ ref('phledw_integration__edw_vw_ph_sfmc_subscriber_status_history') }}
),
temp_a as
(
