with source as
(
    select * from {{ ref('phledw_integration__edw_vw_ph_sfmc_analysis') }}
),
final as
(
    select
	...
	country_name::varchar(20) as country_name,
	...
	mobile_country_code::varchar(30) as mobile_country_code,
	...
	birth_year::varchar(100) as birth_year,
	...
	subscriber_status::varchar(30) as subscriber_status,
	opt_in_for_jnj_communication::varchar(30) as opt_in_for_jnj_communication,
	opt_in_for_campaign::varchar(30) as opt_in_for_campaign,
	viber_engaged::varchar(30) as viber_engaged
    from source
