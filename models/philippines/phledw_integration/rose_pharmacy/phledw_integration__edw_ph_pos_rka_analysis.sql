...
,null as pms_nm
    from ph_pos_rka_rose_pharma as pos
     ...
     left   join ( select distinct item_cd,jj_mnth_id,active,Lst_Price_Unit from  price_list) price on (prod.sap_item_cd=price.item_cd and price.jj_mnth_id <= pos.jj_month_id and price.active='Y') 
