with source as (
select * from {{ ref('phledw_integration__edw_vw_ph_sellout_analysis') }}   
),
final as (
    select
        ...
        jj_wk_no::number(38,0) as jj_wk_no,
        ...
        sap_soldto_code::varchar(255) as sap_soldto_code,
        sap_soldto_nm::varchar(255) as sap_soldto_nm,
        region::varchar(150) as region,
        chnl_cd::varchar(30) as chnl_cd,
        chnl_desc::varchar(100) as chnl_desc,
        sub_chnl_cd::varchar(30) as sub_chnl_cd,
        sub_chnl_desc::varchar(100) as sub_chnl_desc,
        sls_rep_id::varchar(150) as sls_rep_id,
        sls_rep_nm::varchar(250) as sls_rep_nm,
        ...
        town_cd::varchar(50) as town_cd,
        town_nm::varchar(255) as town_nm,
        str_prioritization::varchar(255) as str_prioritization,
        rka_cd::varchar(50) as rka_cd,
        ...
        grs_trd_sls::number(38,12) as grs_trd_sls,
        ret_val::number(38,12) as ret_val,
        trd_discnt::number(23,6) as trd_discnt,
        trd_sls::number(20,4) as trd_sls,
        net_trd_sls::number(22,6) as net_trd_sls,
        jj_grs_trd_sls::number(38,12) as jj_grs_trd_sls,
        jj_ret_val::number(38,12) as jj_ret_val,
        jj_net_sales::number(38,12) as jj_net_sales,
        jj_trd_sls::number(38,8) as jj_trd_sls,
        jj_net_trd_sls::number(38,8) as jj_net_trd_sls,
        ...
        sup_id::varchar(200) as sup_id,
        sup_nm::varchar(200) as sup_nm,
        sales_team::varchar(200) as sales_team
    from source
)
select * from final