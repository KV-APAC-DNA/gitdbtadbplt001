with EDW_ALL_DISTRIBUTOR_LPPB_FACT as(
	select * from DEV_DNA_CORE.SNAPIDNEDW_INTEGRATION.EDW_ALL_DISTRIBUTOR_LPPB_FACT--13264369
),
EDW_TIME_DIM as(
	select * from DEV_DNA_CORE.SNAPIDNEDW_INTEGRATION.EDW_TIME_DIM--5838
),
itg_target_dist_brand_channel as(
	select * from DEV_DNA_CORE.SNAPIDNITG_INTEGRATION.ITG_TARGET_DIST_BRAND_CHANNEL--68196
),
edw_distributor_dim as(
	select * from DEV_DNA_CORE.SNAPIDNEDW_INTEGRATION.edw_distributor_dim--1187
),
edw_product_dim as(
	select * from DEV_DNA_CORE.IDNEDW_INTEGRATION.EDW_PRODUCT_DIM --1674
),
itg_target_bp_s_op as(
	select * from DEV_DNA_CORE.SNAPIDNITG_INTEGRATION.itg_target_bp_s_op --2076
),
