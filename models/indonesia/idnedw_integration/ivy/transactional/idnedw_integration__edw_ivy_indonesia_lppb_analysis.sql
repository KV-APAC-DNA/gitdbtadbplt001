...
(
    SELECT
        ...
        TRIM(UPPER(EDD.DSTRBTR_GRP_CD))::VARCHAR(25) AS DSTRBTR_GRP_CD,
        EDD.DSTRBTR_GRP_NM::VARCHAR(155) AS DSTRBTR_GRP_NM,
        TRIM(UPPER(EDD.JJ_SAP_DSTRBTR_ID))::VARCHAR(75) AS JJ_SAP_DSTRBTR_ID,
        ...
        TRIM(UPPER(EPD.JJ_SAP_PROD_ID))::VARCHAR(50) AS JJ_SAP_PROD_ID,
        ...
        EADLF.STRT_INV_QTY::NUMBER(18,4) AS STRT_INV_QTY,
        EADLF.SELLIN_QTY::NUMBER(18,4) AS SELLIN_QTY,
        EADLF.SELLOUT_QTY::NUMBER(18,4) AS SELLOUT_QTY,
        EADLF.END_INV_QTY::NUMBER(18,4) AS END_INV_QTY,
        EADLF.STRT_INV_VAL::NUMBER(18,4) AS STRT_INV_VAL,
        EADLF.SELLIN_VAL::NUMBER(18,4) AS SELLIN_VAL,
        EADLF.SELLOUT_VAL::NUMBER(18,4) AS SELLOUT_VAL,
        EADLF.END_INV_VAL::NUMBER(18,4) AS END_INV_VAL,
        EADLF.SELLOUT_LAST_TWO_MNTHS_QTY::NUMBER(18,4) AS SELLOUT_LAST_TWO_MNTHS_QTY,
        EADLF.SELLOUT_LAST_TWO_MNTHS_VAL::NUMBER(18,4) AS SELLOUT_LAST_TWO_MNTHS_VAL,
        NULL::VARCHAR(75) as variant,
        ETD.JJ_MNTH_LONG::VARCHAR(75) AS jj_mnth_long,
        0::NUMBER(18,4) as bp_qtn,
        0::NUMBER(18,4) AS bp_val,
        0::NUMBER(18,4) as s_op_qtn,
        0::NUMBER(18,4) AS s_op_val,
        0::NUMBER(18,4) as TRGT_HNA,
        0::NUMBER(18,4) as TRGT_NIV,
        NULL::VARCHAR(1) AS TRGT_BP_S_OP_FLAG,
        NULL::VARCHAR(1) AS TRGT_DIST_BRND_CHNL_FLAG
        FROM
        (SELECT *
