...
SELECT ETD.JJ_YEAR,
      ...
      FROM (SELECT 
                   ...
                   SUM(SELLOUT_VAL) OVER (PARTITION BY JJ_SAP_DSTRBTR_ID,JJ_SAP_PROD_ID ORDER BY JJ_MNTH_ID ROWS BETWEEN 2 PRECEDING AND 1 PRECEDING) AS P3M_SELLOUT_VAL
                   SUM(GROSS_SELLOUT_VAL) OVER (PARTITION BY JJ_SAP_DSTRBTR_ID,JJ_SAP_PROD_ID ORDER BY JJ_MNTH_ID ROWS BETWEEN 2 PRECEDING AND 1 PRECEDING) AS P3M_GROSS_SELLOUT_VAL
                   SUM(SELLOUT_VAL) OVER (PARTITION BY JJ_SAP_DSTRBTR_ID,JJ_SAP_PROD_ID ORDER BY JJ_MNTH_ID ROWS BETWEEN 2 PRECEDING AND 1 PRECEDING) AS P6M_SELLOUT_VAL
                   SUM(GROSS_SELLOUT_VAL) OVER (PARTITION BY JJ_SAP_DSTRBTR_ID,JJ_SAP_PROD_ID ORDER BY JJ_MNTH_ID ROWS BETWEEN 2 PRECEDING AND 1 PRECEDING) AS P6M_GROSS_SELLOUT_VAL
            FROM 
