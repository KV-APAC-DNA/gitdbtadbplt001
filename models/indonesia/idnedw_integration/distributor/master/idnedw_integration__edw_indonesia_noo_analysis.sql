...
SELECT CAST(YEAR AS INTEGER) AS JJ_YEAR,
    ...
    null as latest_dsitributor_name  
...
transformed.latest_dsitributor_name 
from transformed  
left join temp_a
...
(
    ...
    latest_dsitributor_name::varchar(200) as latest_dsitributor_name
    from updt5
)
select * from final
