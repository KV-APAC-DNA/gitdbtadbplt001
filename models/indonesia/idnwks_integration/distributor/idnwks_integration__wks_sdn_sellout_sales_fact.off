...
EDW_DISTRIBUTOR_CHANNEL_DIM as(
    select * from DEV_DNA_CORE.IDNEDW_INTEGRATION.EDW_DISTRIBUTOR_CHANNEL_DIM
),
EDW_DISTRIBUTOR_METADATA_LKP as(
    select * from DEV_DNA_CORE.IDNEDW_INTEGRATION.EDW_DISTRIBUTOR_METADATA_LKP
),
EDW_TIME_DIM as(
...
EDW_DISTRIBUTOR_PRODUCT_DIM as(
    select * from DEV_DNA_CORE.IDNEDW_INTEGRATION.EDW_DISTRIBUTOR_PRODUCT_DIM
),
