...
wks_au_pharma_lst12_mnth_dstrbtn_check_prod as (
select delvry_dt,
       acct_key,
       prod_key,
...
wks_au_pharma_lst12_mnth_dstrbtn_check_acct as (
select delvry_dt,
       acct_key,
       prod_key,
...
from wks_au_pharma_lst12_mnth_dstrbtn_check_prod p,
    wks_au_pharma_lst12_mnth_dstrbtn_check_acct a
