...
BASE_DATA as (
    ...
    GROUP BY CAL.YEAR,
        ...
        TRIM(NVL(NULLIF(T3.GPH_PROD_FRNCHSE, ''), 'NA')),
        TRIM(NVL(NULLIF(T3.GPH_PROD_BRND, ''), 'NA')),
        TRIM(NVL(NULLIF(T3.GPH_PROD_SUB_BRND, ''), 'NA')),
        TRIM(NVL(NULLIF(T3.GPH_PROD_VRNT, ''), 'NA')),
        TRIM(NVL(NULLIF(T3.GPH_PROD_SGMNT, ''), 'NA')),
        TRIM(NVL(NULLIF(T3.GPH_PROD_SUBSGMNT, ''), 'NA')),
        TRIM(NVL(NULLIF(T3.GPH_PROD_CTGRY, ''), 'NA')),
        TRIM(NVL(NULLIF(T3.GPH_PROD_SUBCTGRY, ''), 'NA')),
        --TRIM(NVL(NULLIF(T3.GPH_PROD_PUT_UP_DESC,''),'NA')) AS GLOBAL_PUT_UP_DESC,
        TRIM(NVL(NULLIF(T3.SAP_MATL_NUM, ''), 'NA')),
        TRIM(NVL(NULLIF(T3.SAP_MAT_DESC, ''), 'NA')),
        -- TRIM(NVL(NULLIF(T3.greenlight_sku_flag,''),'NA')) AS greenlight_sku_flag,
        ...
        TRIM(NVL(NULLIF(T3.product_key, ''), 'NA')),
        TRIM(NVL(NULLIF(T3.product_key_description, ''), 'NA')),
