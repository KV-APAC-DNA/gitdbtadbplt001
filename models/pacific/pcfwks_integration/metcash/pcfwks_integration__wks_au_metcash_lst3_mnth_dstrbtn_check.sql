...
prod_lst3_mnth_qty_query as (select count(c.unit_qty) as prod_lst3_mnth_qty
...
acct_lst3_mnth_qty_query as (select count(c.unit_qty) as acct_lst3_mnth_qty
              from wks_au_metcash_monthly c,
              wks_au_metcash_prod_acct_date_comb a,
              wks_au_metcash_dstrbtn_date_range b
              where c.delvry_dt > b.lst3_mnth_delvry_dt
...
from (select a.delvry_dt,
      ...
      from wks_au_metcash_prod_acct_date_comb a,
           wks_au_metcash_dstrbtn_date_range b,
           prod_lst3_mnth_qty_query,
           acct_lst3_mnth_qty_query
...
select * from wks_au_metcash_lst3_mnth_dstrbtn_check