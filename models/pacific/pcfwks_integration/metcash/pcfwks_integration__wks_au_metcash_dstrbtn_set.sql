with wks_au_metcash_curnt_mnth as (
    select * from {{ ref('pcfwks_integration__wks_au_metcash_curnt_mnth') }}
),
wks_au_metcash_lst_mnth as (
    select * from {{ ref('pcfwks_integration__wks_au_metcash_lst_mnth') }}
),
wks_au_metcash_lst3_mnth as (
    select * from {{ ref('pcfwks_integration__wks_au_metcash_lst3_mnth') }}
),
wks_au_metcash_lst6_mnth as (
    select * from {{ ref('pcfwks_integration__wks_au_metcash_lst6_mnth') }}
),
wks_au_metcash_lst12_mnth as (
    select * from {{ ref('pcfwks_integration__wks_au_metcash_lst12_mnth') }}
),
wks_au_metcash_curnt_mnth_dstrbtn_check as (
    select * from {{ ref('pcfwks_integration__wks_au_metcash_curnt_mnth_dstrbtn_check') }}
),
wks_au_metcash_lst_mnth_dstrbtn_check as (
    select * from {{ ref('pcfwks_integration__wks_au_metcash_lst_mnth_dstrbtn_check') }}
),
wks_au_metcash_lst3_mnth_dstrbtn_check as (
    select * from {{ ref('pcfwks_integration__wks_au_metcash_lst3_mnth_dstrbtn_check') }}
),
wks_au_metcash_lst6_mnth_dstrbtn_check as (
    select * from {{ ref('pcfwks_integration__wks_au_metcash_lst6_mnth_dstrbtn_check') }}
),
wks_au_metcash_lst12_mnth_dstrbtn_check as (
    select * from {{ ref('pcfwks_integration__wks_au_metcash_lst12_mnth_dstrbtn_check') }}
),
wks_au_metcash_dstrbtn_set as (
...
from wks_au_metcash_curnt_mnth wapcm,
     wks_au_metcash_lst_mnth waplm,
     wks_au_metcash_lst3_mnth wapl3m,
     wks_au_metcash_lst6_mnth wapl6m,
     wks_au_metcash_lst12_mnth wapl12m,
     wks_au_metcash_curnt_mnth_dstrbtn_check wapcmdc,
     wks_au_metcash_lst_mnth_dstrbtn_check waplmdc,
     wks_au_metcash_lst3_mnth_dstrbtn_check wapl3mdc,
     wks_au_metcash_lst6_mnth_dstrbtn_check wapl6mdc,
     wks_au_metcash_lst12_mnth_dstrbtn_check wapl12mdc
...
select * from wks_au_metcash_dstrbtn_set