with wks_au_metcash_dstrbtn_set as (
    select * from {{ ref('pcfwks_integration__wks_au_metcash_dstrbtn_set') }}
),
...
from wks_au_metcash_dstrbtn_set
)
select * from wks_au_metcash_dstrbtn_summary