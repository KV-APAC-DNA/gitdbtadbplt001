...
union2 as(
    ...
    where
    edfs.pac_subsource_type = 'PX_FORECAST'
...
union3 as(
    select
        ...
        ltrim(vmd.matl_id, 0) as matl_no,
        vmd.matl_desc,
        mstrcdd3.master_code,
        ltrim(vapcd.parent_id, 0) as parent_id,
        mstrcdd3.parent_matl_desc,
        vmd.mega_brnd_cd,
        vmd.mega_brnd_desc,
        vmd.brnd_cd,
        vmd.brnd_desc,
    ...
    select distinct
        ...
        fcst_chnl_desc
    from vw_dmnd_frcst_customer_dim
    ) as vcd, vw_material_dim as vmd, vw_apo_parent_child_dim as vapcd,  mstrcdd3
    where
    ...
    and vapcd.master_code =  mstrcdd3.master_code(+)
),
transformed as(
    select * from union1
    union all
