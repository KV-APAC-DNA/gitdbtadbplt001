...
select wapds.delvry_dt,
	   ...
	   epmi.msl_rank as ig_msl_rank,
       --case when epmi.msl_rank is not null 
		--	then 'yes' 
		--	else 'no' 
	  -- end as ig_msl_flag,
      epmi.msl_flag as ig_msl_flag,
       current_timestamp() as load_date            
from edw_time_dim etd,
     wks_au_metcash_dstrbtn_summary wapds,
...
and  upper(epmi.retail_environment(+)) = 'INDEPENDENT GROCERY'
...
ig_msl_rank::varchar(5) as ig_msl_rank,
ig_msl_flag::varchar(3) as ig_msl_flag,
load_date::timestamp_ntz(9) as load_date
from transformed
)
select * from edw_pacific_metcash_dstrbtn_analysis