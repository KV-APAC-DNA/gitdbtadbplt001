...
vdfa as (
    select
        pac_source_type,
        pac_subsource_type,
        DATEADD(HOUR, -16, (convert_timezone('UTC', current_timestamp )::TIMESTAMPNTZ )::DATE)::date as snap_shot_dt,
        jj_period,
        jj_week_no,
        jj_wk,
        jj_mnth,
...
etd as(
    select
        DATEADD(HOUR, -16, (convert_timezone('UTC', current_timestamp )::TIMESTAMPNTZ )::DATE) ::date as  snapshot_date,
...
vdfaa as (
    ...
    AS PREV_JJ_PERIOD FROM EDW_TIME_DIM T1 WHERE CAL_DATE::date = 
