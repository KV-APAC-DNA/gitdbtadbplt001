...
`				CASE 
				WHEN UPPER(ecpf.target_type)='GOAL'
                THEN (
				ecpf.goal_qty)
				ELSE 0
				END AS goal_qty,
...
`				CASE 
				WHEN UPPER(ecpf.target_type)='BP'
                THEN (
				ecpf.bp_qty)
				ELSE 0
				END AS bp_qty,
	...
	---------------------------------------------------------------------------------------			  
`				CASE 
				WHEN UPPER(ecpf.target_type)='JU'
                THEN (
				ecpf.ju_qty)
				ELSE 0
				END AS ju_qty,
	...
	-----------------------------------------------------------------------------------------			  
`				CASE 
				WHEN UPPER(ecpf.target_type)='NU'
                THEN (
				ecpf.nu_qty)
				ELSE 0
				END AS nu_qty,
