...
AND   P.IS_DELETED =0
AND   T.IS_DELETED =0
AND   NVL(P.START_DATE,SYSDATE()) > (SELECT DATE_TRUNC(YEAR, dateadd(day,-RETENTION_YEARS*365,SYSDATE())) FROM itg_lookup_retention_period WHERE UPPER(TABLE_NAME) = 'FACT_CYCLE_PLAN') 
