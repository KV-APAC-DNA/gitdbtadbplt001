...
AS (
    SELECT src1.jnj_date_year AS jnj_year,
        ...
        CASE 
            WHEN (
                    ((((src1.jnj_date_year)::CHARACTER VARYING)::TEXT || ('-'::CHARACTER VARYING)::TEXT) || (src1.jnj_date_month)::TEXT) = (
                        (
                            (
                                (
                                    date_part (
    ...
    SELECT NULL AS jnj_year,
        ...
        CASE 
            WHEN (
                    ((((src1.my_date_year)::CHARACTER VARYING)::TEXT || ('-'::CHARACTER VARYING)::TEXT) || ((src1.my_date_month)::CHARACTER VARYING)::TEXT) = (
                        (
                            (
                                (
                                    date_part (
...
t2 AS (
        SELECT NULL AS jnj_year,
            ...
            CASE 
                WHEN (
                        ((((src1.date_year)::CHARACTER VARYING)::TEXT || ('-'::CHARACTER VARYING)::TEXT) || (src1.date_month)::TEXT) = (
                            (
                                (
                                    (
                                        date_part (
