...
SELECT DISTINCT 
    ...
    (case when upper(itg_hcp.inactive) = 1 then current_timestamp() when upper(itg_hcp.inactive) is null then null when upper(itg_hcp.inactive) = ' ' then null else null end) as inactive_date,
