...
FROM (SELECT COUNTRY_CODE,
  ...
  LEFT JOIN WKS_SINGAPORE_REGIONAL_SELLOUT_MAPPED_SKU_CD MSCD ON LTRIM (MAIN.MSL_PRODUCT_CODE,'0') = LTRIM (MSCD.MASTER_CODE,'0')		--//   LEFT JOIN OS_WKS.WKS_SINGAPORE_REGIONAL_SELLOUT_MAPPED_SKU_CD MSCD ON LTRIM (MAIN.MSL_PRODUCT_CODE,'0') = LTRIM (MSCD.MASTER_CODE,'0')
