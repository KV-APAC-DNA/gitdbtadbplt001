...
(
    ...
    (
        ...
        ) AS DECIMAL(38, 5)) AS trdng_term_val,
        (
            t2.gts_val - (
            (
                (
        ...
        CAST((
            CAST(NULL AS DECIMAL)
        ) AS DECIMAL(38, 5)) AS trde_prmtn_val,
        CAST((
            CAST(NULL AS DECIMAL)
        ...
        SELECT
            ...
            SUM(
            CASE  WHEN (CAST((t1.acct_hier_desc) AS TEXT) = CAST('Gross Trade Shipment' AS TEXT))
                    THEN t1.qty
                ELSE CAST(( 0 ) AS DECIMAL)
            END
            ) AS sls_qty,
            SUM(
            CASE  WHEN (CAST((t1.acct_hier_desc) AS TEXT) = CAST('Returns' AS TEXT))
                    THEN t1.qty
                ELSE CAST(( 0 ) AS DECIMAL)
            END
            ) AS ret_qty,
            SUM(
            CASE
                WHEN (CAST((t1.acct_hier_desc) AS TEXT) = CAST('Gross Trade Shipment' AS TEXT))
            ...
            SUM(
            CASE  WHEN (CAST((t1.acct_hier_desc) AS TEXT) = CAST('Sales Allowances' AS TEXT))
                    THEN t1.amt_obj_crncy
                    ELSE CAST(( 0 ) AS DECIMAL)
            END
            ) AS sls_alwnce,
            SUM(
            CASE
                WHEN ( CAST((  t1.acct_hier_desc) AS TEXT) = CAST('Cash Discount' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((  0) AS DECIMAL)
            END
            ...
            SUM(
            CASE
                WHEN (CAST((t1.acct_hier_desc) AS TEXT) = CAST('Hidden Dsct Markdown Allowance' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((0) AS DECIMAL)
            END
            ...
            SUM(
            CASE
                WHEN (CAST((  t1.acct_hier_desc) AS TEXT) = CAST('Hidden Dsct Profit Margin' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((  0) AS DECIMAL)
            END
            ...
            SUM(
            CASE
                WHEN (CAST((  t1.acct_hier_desc) AS TEXT) = CAST('Hidden Dsct Promotion' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((  0) AS DECIMAL)
            END
            ...
            CASE
                ...
                CAST((
                    t1.acct_hier_desc
                ) AS TEXT) = CAST('Logistics Fees' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((
                0
            ...
            CASE
                ...
                CAST((
                    t1.acct_hier_desc
                ) AS TEXT) = CAST('Non-Government Chargebacks' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((
                0
            ...
            CASE
                ...
                CAST((
                    t1.acct_hier_desc
                ) AS TEXT) = CAST('Pricing/Space Others' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((
                0
            ...
            CASE
                ...
                CAST((
                    t1.acct_hier_desc
                ) AS TEXT) = CAST('Profit Margin Allowance' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((
                0
            ...
            CASE
                ...
                CAST((
                    t1.acct_hier_desc
                ) AS TEXT) = CAST('Term & Logistic Others' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((
                0
            ...
            CASE
                ...
                CAST((
                    t1.acct_hier_desc
                ) AS TEXT) = CAST('Volume Growth Funds' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((
                0
        ...
        SELECT
            ...
            WHEN (
                LTRIM(CAST((
                t1.matl_num
                ) AS TEXT), CAST('0' AS TEXT)) = CAST('' AS TEXT)
            )
            ...
            LTRIM(CAST((
            t1.cust_num
            ) AS TEXT), CAST('0' AS TEXT)) AS customer,
            t1.sls_org,
            t1.plnt,
            t1.dstr_chnl,
            LTRIM(CAST((
            ...
            LTRIM(CAST((
            t1.cust_sls
            ) AS TEXT), CAST('0' AS TEXT)) AS cust_sls,
            t1.fisc_yr,
            t1.pstng_per,
            SUM(t1.amt_obj_crncy) AS base_val,
            SUM(
            ...
            CASE
                ...
                CAST((
                    t1.acct_hier_desc
                ) AS TEXT) = CAST('Sales Allowances' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((
                0
            ...
            CASE
                ...
                CAST((
                    t1.acct_hier_desc
                ) AS TEXT) = CAST('Cash Discount' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((
                0
            ...
            CASE
                ...
                CAST((
                    t1.acct_hier_desc
                ) AS TEXT) = CAST('Hidden Dsct Markdown Allowance' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((
                0
            ...
            CASE
                ...
                CAST((
                    t1.acct_hier_desc
                ) AS TEXT) = CAST('Hidden Dsct Profit Margin' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((
                0
            ...
            CASE
                ...
                CAST((
                    t1.acct_hier_desc
                ) AS TEXT) = CAST('Hidden Dsct Promotion' AS TEXT)
                )
                THEN t1.amt_obj_crncy
                ELSE CAST((
                0
        ...
        WHERE
            ...
            (
                CAST((
                t1.sls_org
                ) AS TEXT) = CAST('2400' AS TEXT)
            )
            OR (
                CAST((
                t1.sls_org
                ) AS TEXT) = CAST('2500' AS TEXT)
            )
            )
            AND t1.ctry_key::text = 'SG'
        GROUP BY
