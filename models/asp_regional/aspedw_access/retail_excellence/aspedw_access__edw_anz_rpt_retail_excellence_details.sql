with edw_anz_rpt_retail_excellence_details as (
    select * from {{ ref('aspedw_integration__edw_rpt_retail_excellence_details_anz') }}
),
...
sysdate() as "sysdate()"
    from edw_anz_rpt_retail_excellence_details
)
