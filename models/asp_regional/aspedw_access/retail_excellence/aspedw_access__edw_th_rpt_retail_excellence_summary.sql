with edw_th_rpt_retail_excellence_summary as (
    select * from {{ ref('aspedw_integration__edw_rpt_retail_excellence_summary_th') }}
),
...
crt_dttm as "crt_dttm"
    from edw_th_rpt_retail_excellence_summary
)
