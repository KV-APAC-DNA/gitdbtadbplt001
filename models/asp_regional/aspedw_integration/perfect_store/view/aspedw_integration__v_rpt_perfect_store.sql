...
sgp as (
    SELECT UPPER(v_rpt_sg_pop6_perfect_store.dataset::TEXT)::CHARACTER VARYING AS dataset,
        v_rpt_sg_pop6_perfect_store.merchandisingresponseid::varchar as merchandisingresponseid,
        v_rpt_sg_pop6_perfect_store.surveyresponseid::varchar as surveyresponseid,
        v_rpt_sg_pop6_perfect_store.customerid::varchar as customerid,
        v_rpt_sg_pop6_perfect_store.salespersonid::varchar as salespersonid,
        v_rpt_sg_pop6_perfect_store.visitid::varchar as visitid,
        ...
        v_rpt_sg_pop6_perfect_store.mrch_resp_status::varchar as mrch_resp_status,
        v_rpt_sg_pop6_perfect_store.mastersurveyid::varchar as mastersurveyid,
        v_rpt_sg_pop6_perfect_store.survey_status::varchar as survey_status,
        v_rpt_sg_pop6_perfect_store.survey_enddate::CHARACTER VARYING AS survey_enddate,
        v_rpt_sg_pop6_perfect_store.questionkey::varchar as questionkey,
        v_rpt_sg_pop6_perfect_store.questiontext::varchar as questiontext,
        v_rpt_sg_pop6_perfect_store.valuekey::varchar as valuekey,
        v_rpt_sg_pop6_perfect_store.value::varchar as value,
        v_rpt_sg_pop6_perfect_store.productid::varchar as productid,
        ...
        v_rpt_sg_pop6_perfect_store.category::varchar as category,
        v_rpt_sg_pop6_perfect_store.segment::varchar as segment,
        v_rpt_sg_pop6_perfect_store.vst_visitid::varchar as vst_visitid,
        v_rpt_sg_pop6_perfect_store.scheduleddate::varchar as scheduleddate,
        ...
        iff(
            v_rpt_sg_pop6_perfect_store.fisc_yr = '',
            null,
            v_rpt_sg_pop6_perfect_store.fisc_yr
        )::INTEGER as fisc_yr,
        iff(
            v_rpt_sg_pop6_perfect_store.fisc_per = '',
            null,
            v_rpt_sg_pop6_perfect_store.fisc_per
        )::INTEGER as fisc_per,
        v_rpt_sg_pop6_perfect_store.firstname::varchar as firstname,
        v_rpt_sg_pop6_perfect_store.lastname::varchar as lastname,
        v_rpt_sg_pop6_perfect_store.cust_remotekey::varchar as cust_remotekey,
        v_rpt_sg_pop6_perfect_store.customername::varchar as customername,
        v_rpt_sg_pop6_perfect_store.country::varchar as country,
        v_rpt_sg_pop6_perfect_store.state::varchar as state,
        v_rpt_sg_pop6_perfect_store.county::varchar as county,
        v_rpt_sg_pop6_perfect_store.district::varchar as district,
        v_rpt_sg_pop6_perfect_store.city::varchar as city,
        v_rpt_sg_pop6_perfect_store.storereference::varchar as storereference,
        v_rpt_sg_pop6_perfect_store.storetype::varchar as storetype,
        v_rpt_sg_pop6_perfect_store.channel::varchar as channel,
        v_rpt_sg_pop6_perfect_store.salesgroup::varchar as salesgroup,
        v_rpt_sg_pop6_perfect_store.bu::varchar as bu,
        v_rpt_sg_pop6_perfect_store.soldtoparty::varchar as soldtoparty,
        NULL AS brand,
        v_rpt_sg_pop6_perfect_store.productname::varchar as productname,
        v_rpt_sg_pop6_perfect_store.eannumber::varchar as eannumber,
        v_rpt_sg_pop6_perfect_store.matl_num::varchar as matl_num,
        v_rpt_sg_pop6_perfect_store.prod_hier_l1::varchar as prod_hier_l1,
        v_rpt_sg_pop6_perfect_store.prod_hier_l2::varchar as prod_hier_l2,
        v_rpt_sg_pop6_perfect_store.prod_hier_l3::varchar as prod_hier_l3,
        v_rpt_sg_pop6_perfect_store.prod_hier_l4::varchar as prod_hier_l4,
        v_rpt_sg_pop6_perfect_store.prod_hier_l5::varchar as prod_hier_l5,
        v_rpt_sg_pop6_perfect_store.prod_hier_l6::varchar as prod_hier_l6,
        v_rpt_sg_pop6_perfect_store.prod_hier_l7::varchar as prod_hier_l7,
        v_rpt_sg_pop6_perfect_store.prod_hier_l8::varchar as prod_hier_l8,
        v_rpt_sg_pop6_perfect_store.prod_hier_l9::varchar as prod_hier_l9,
        v_rpt_sg_pop6_perfect_store.kpi_chnl_wt::varchar as kpi_chnl_wt,
        v_rpt_sg_pop6_perfect_store.mkt_share::varchar as mkt_share,
        UPPER(v_rpt_sg_pop6_perfect_store.ques_desc::TEXT)::CHARACTER VARYING AS ques_desc,
        v_rpt_sg_pop6_perfect_store."y/n_flag",
        NULL AS posm_execution_flag,
        v_rpt_sg_pop6_perfect_store.rej_reason::varchar as rej_reason,
        v_rpt_sg_pop6_perfect_store.response::varchar as response,
        v_rpt_sg_pop6_perfect_store.response_score::varchar as response_score,
        v_rpt_sg_pop6_perfect_store.acc_rej_reason::varchar as acc_rej_reason,
        NULL AS actual,
        NULL AS "target",
        'Y' AS priority_store_flag,
        NULL AS photo_url,
