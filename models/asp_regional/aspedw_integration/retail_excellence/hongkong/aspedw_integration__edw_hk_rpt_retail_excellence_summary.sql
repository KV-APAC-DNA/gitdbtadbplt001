--Import CTE
with hk_edw_rpt_retail_excellence_summary_base as (
    select *
    from
        {{ ref('aspedw_integration__edw_hk_rpt_retail_excellence_summary_base') }}
),

--Final CTE
hk_edw_rpt_retail_excellence_summary as (
    select
        fisc_yr,
        fisc_per,
        "cluster",
    ...
    from hk_edw_rpt_retail_excellence_summary_base
    where
        fisc_per
        > TO_CHAR(ADD_MONTHS((
...
final as (
    ...
    from hk_edw_rpt_retail_excellence_summary
)
