--Import CTE
with hk_edw_rpt_retail_excellence as (
    select * from {{ ref('ntaedw_integration__edw_hk_rpt_retail_excellence') }}
),

--Logical CTE
hk_edw_rpt_retail_excellence_details as (
SELECT FISC_YR,
       FISC_PER :: numeric(18,0) as FISC_PER,		--// INTEGER
       "cluster",
       MARKET,
       CHANNEL_NAME,
       DISTRIBUTOR_CODE,
...
final as (
    ...
    sold_to_code::VARCHAR(20) AS soldto_code,
    crt_dttm::TIMESTAMP WITHOUT TIME ZONE AS crt_dttm
    from hk_edw_rpt_retail_excellence_details
)
