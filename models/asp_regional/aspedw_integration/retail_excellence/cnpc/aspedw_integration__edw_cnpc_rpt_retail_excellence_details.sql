...
SALES_VALUE_LIST_PRICE,	
	   ...
	   current_timestamp()::date AS CRT_DTTM	
			  ...
			  WHERE 
			  market = 'China Personal Care' and RETAIL_ENVIRONMENT not in (select distinct parameter_value from itg_query_parameters where parameter_name='EXCLUDE_RE_RETAIL_ENV' and 
			  country_code='CNPC') 
...
--Final select
select * from cnpc_edw_rpt_retail_excellence_details