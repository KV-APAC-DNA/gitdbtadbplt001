with edw_cnsc_rpt_retail_excellence_details as (
...
edw_id_rpt_retail_excellence_details as (
...
SELECT * FROM edw_cnsc_rpt_retail_excellence_details UNION
SELECT * FROM edw_cnpc_rpt_retail_excellence_details UNION
SELECT * FROM edw_in_rpt_retail_excellence_details UNION
SELECT * FROM edw_id_rpt_retail_excellence_details UNION
SELECT * FROM edw_jp_rpt_retail_excellence_details UNION
SELECT * FROM edw_my_rpt_retail_excellence_details UNION
SELECT * FROM edw_ph_rpt_retail_excellence_details UNION
SELECT * FROM edw_sg_rpt_retail_excellence_details UNION
SELECT * FROM edw_kr_rpt_retail_excellence_details UNION
SELECT * FROM edw_anz_rpt_retail_excellence_details UNION
SELECT * FROM edw_th_rpt_retail_excellence_details 
)
