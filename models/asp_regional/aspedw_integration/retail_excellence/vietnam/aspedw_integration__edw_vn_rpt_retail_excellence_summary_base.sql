...
with v_edw_vn_rpt_retail_excellence as (
    select * from {{ ref('vnmedw_integration__edw_vn_rpt_retail_excellence') }}
),
...
vn_rpt_retail_excellence_summary_base as (
    select
    ...
    distributor_name::VARCHAR(900) AS distributor_name,
    ...
    prod_hier_l7::VARCHAR(255) AS prod_hier_l7,
    prod_hier_l8::VARCHAR(255) AS prod_hier_l8,
    prod_hier_l9::VARCHAR(1) AS prod_hier_l9,
    global_product_franchise::VARCHAR(255) AS global_product_franchise,
    global_product_brand::VARCHAR(255) AS global_product_brand,
    global_product_sub_brand::VARCHAR(255) AS global_product_sub_brand,
    global_product_segment::VARCHAR(255) AS global_product_segment,
    global_product_subsegment::VARCHAR(255) AS global_product_subsegment,
    global_product_category::VARCHAR(255) AS global_product_category,
    global_product_subcategory::VARCHAR(255) AS global_product_subcategory,
...
--Final select
select * from vn_rpt_retail_excellence_summary_base