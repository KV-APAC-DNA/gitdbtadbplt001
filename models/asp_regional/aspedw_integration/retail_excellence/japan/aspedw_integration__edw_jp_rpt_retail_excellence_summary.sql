...
--Final CTE
jp_edw_rpt_retail_excellence_summary_final as (
SELECT FISC_YR,
       FISC_PER,
       "CLUSTER",
       MARKET,
...
jp_edw_rpt_retail_excellence_summary as
(
  select 
  ...
  from jp_edw_rpt_retail_excellence_summary_final
)
--Final select
select * from jp_edw_rpt_retail_excellence_summary 