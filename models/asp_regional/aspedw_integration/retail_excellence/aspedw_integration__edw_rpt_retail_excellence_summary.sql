...
edw_vn_rpt_retail_excellence_summary as (
    select * from {{ ref('aspedw_integration__edw_vn_rpt_retail_excellence_summary') }}
),
edw_hk_rpt_retail_excellence_summary as (
    select * from {{ ref('aspedw_integration__edw_hk_rpt_retail_excellence_summary') }}
),
edw_tw_rpt_retail_excellence_summary as (
    select * from {{ ref('aspedw_integration__edw_tw_rpt_retail_excellence_summary') }}
),
...
SELECT * FROM edw_vn_rpt_retail_excellence_summary UNION
