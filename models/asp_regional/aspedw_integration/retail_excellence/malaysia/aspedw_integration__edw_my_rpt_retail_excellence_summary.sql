...
--Import CTE
with my_edw_rpt_retail_excellence_summary_base as (
    select * from {{ ref('aspedw_integration__edw_my_rpt_retail_excellence_summary_base') }}
),
...
--Final select
select * from my_edw_rpt_retail_excellence_summary 