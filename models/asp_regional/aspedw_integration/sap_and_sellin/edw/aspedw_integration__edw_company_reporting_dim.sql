...
union all
select a.*,b.*,'Taiwan DCL' as reporting_market,"cluster" as reporting_cluster from edw_company_dim a,(select 'Dr Ci Labo' as mega_brnd_desc) b where ctry_group='Taiwan'
union all
select a.*,b.*,'Singapore DCL' as reporting_market,"cluster" as reporting_cluster from edw_company_dim a,(select 'Dr Ci Labo' as mega_brnd_desc) b where ctry_group='Singapore'
union all
select a.*,b.*,'Hong Kong DCL' as reporting_market,"cluster" as reporting_cluster from edw_company_dim a,(select 'Dr Ci Labo' as mega_brnd_desc) b where ctry_group='Hong Kong'
union all
select a.*,b.*,'Thailand DCL' as reporting_market,"cluster" as reporting_cluster from edw_company_dim a,(select 'Dr Ci Labo' as mega_brnd_desc) b where ctry_group='Thailand'
union all
