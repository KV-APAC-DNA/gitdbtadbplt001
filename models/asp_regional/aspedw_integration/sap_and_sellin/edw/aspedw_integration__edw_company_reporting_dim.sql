...
union all
select a.*,b.*,'China DCL' as reporting_market,'One DCL' as reporting_cluster  from edw_company_dim a,(select 'Dr Ci Labo' as mega_brnd_desc) b where ctry_group='China Personal Care'
union all
...
union all
select a.*,b.*,ctry_group as reporting_market,"cluster" as reporting_cluster  from edw_company_dim a,(select 'Dr Ci Labo' as mega_brnd_desc) b where ctry_group='China Selfcare'
union all
select a.*,b.*,ctry_group as reporting_market,"cluster" as reporting_cluster from edw_company_dim a,(select 'Dr Ci Labo' as mega_brnd_desc) b where ctry_group='Taiwan'
union all
select a.*,b.*,ctry_group as reporting_market,"cluster" as reporting_cluster from edw_company_dim a,(select 'Dr Ci Labo' as mega_brnd_desc) b where ctry_group='Singapore'
union all
