with source as(
    select * from {{ ref('aspitg_integration__itg_delivery_fact') }}
),
final as(
 select 
    ...
    cast(dlv_qty as decimal(20,4)) as dlv_qty,
    cast(denomintr as decimal(20,4)) as denomintr,
    cast(numerator as decimal(20,4)) as numerator,
   shp_pr_tmf::VARCHAR(50) as shp_pr_tmf,
    ...
    cast(act_dl_qty as decimal(20,4)) as act_dl_qty,
    ...
    zdelqtybu::NUMBER(20,4) as zdelqtybu,
    zdlqtycse::NUMBER(20,4) as zdlqtycse,
