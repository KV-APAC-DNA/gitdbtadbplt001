...
cast("parent customer" as varchar(50)) as parent_customer,
banner::varchar(50) as banner,
cast("banner format" as varchar(50)) as banner_format,
channel::varchar(50) as channel,
cast("go to model" as varchar(50)) as go_to_model,
cast("sub channel" as varchar(50) ) as sub_channel,
