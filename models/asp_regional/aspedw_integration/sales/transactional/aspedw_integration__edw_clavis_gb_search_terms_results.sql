with itg_clavis_gb_search_terms_results as
(
    select * from {{ ref('aspitg_integration__itg_clavis_gb_search_terms_results') }}
),
final as
(
    select
    ...
    from itg_clavis_gb_search_terms_results
)
select * from final