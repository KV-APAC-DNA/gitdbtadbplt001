with wks_commercial_excellence_gts_summation_mtd as (
    select * from {{ ref('aspwks_integration__wks_commercial_excellence_gts_summation_mtd') }}
),
final as (
...
From wks_commercial_excellence_gts_summation_mtd base
   left join wks_commercial_excellence_gts_summation_mtd base_ytd
      on base_ytd.market = base.market AND base_ytd."cluster" = base."cluster" AND base_ytd.cust_seg = base.cust_seg AND base_ytd.mega_brand = base.mega_brand AND base_ytd.kpi = base.kpi
...
Group by base.market, base."cluster", base.cust_seg, base.mega_brand, base.kpi, base.month_id, base.mtd_lcy, base.mtd_usd
