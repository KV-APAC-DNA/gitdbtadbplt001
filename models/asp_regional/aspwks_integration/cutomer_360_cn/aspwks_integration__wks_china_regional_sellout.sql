...
(
    ...
    (SELECT  
        ...
        (C.EXCH_RATE/(C.from_ratio*C.to_ratio))::NUMERIC(15,5) as EXCHANGE_RATE,
            ...
            SUM(SO_SLS_VALUE*((C.EXCH_RATE/(C.from_ratio*C.to_ratio))::NUMERIC(15,5))) SELLOUT_SALES_VALUE_USD,
            ...
            SELLOUT.crtd_dttm,
        SELLOUT.updt_dttm
    FROM    wks_china_regional_sellout_base  SELLOUT
    ...
    --sls_org IN ('1000','1500','1588','1600','1700','1800','1900')		  
            FROM 
