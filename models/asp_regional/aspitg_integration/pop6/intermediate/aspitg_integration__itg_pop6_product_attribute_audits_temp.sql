...
sdl_pop6_tw_product_attribute_audits as (
    select * from {{ref('aspwks_integration__wks_pop6_tw_product_attribute_audits')}}
),
sdl_pop6_hk_product_attribute_audits as (
    select * from {{ref('aspwks_integration__wks_pop6_hk_product_attribute_audits')}}
),
sdl_pop6_jp_product_attribute_audits as (
    select * from {{ref('aspwks_integration__wks_pop6_jp_product_attribute_audits')}}
),
sdl_pop6_sg_product_attribute_audits as (
    select * from {{ref('aspwks_integration__wks_pop6_sg_product_attribute_audits')}}
),
sdl_pop6_th_product_attribute_audits as (
    select * from {{ref('aspwks_integration__wks_pop6_th_product_attribute_audits')}}
),
transformed as (
    SELECT 
        'KR' as cntry_cd,
