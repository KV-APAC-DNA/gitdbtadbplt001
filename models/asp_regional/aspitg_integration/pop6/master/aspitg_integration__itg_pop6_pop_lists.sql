...
with sdl_pop6_hk_pop_lists as (
    select * from {{ref('aspwks_integration__wks_pop6_hk_pop_lists')}}
),
sdl_pop6_kr_pop_lists as (
    select * from {{ref('aspwks_integration__wks_pop6_kr_pop_lists')}}
),
sdl_pop6_tw_pop_lists as (
    select * from {{ref('aspwks_integration__wks_pop6_tw_pop_lists')}}
),
sdl_pop6_jp_pop_lists as (
    select * from {{ref('aspwks_integration__wks_pop6_jp_pop_lists')}}
),
sdl_pop6_sg_pop_lists as (
    select * from {{ref('aspwks_integration__wks_pop6_sg_pop_lists')}}
),
