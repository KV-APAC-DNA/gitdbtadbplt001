...
(
	select * from {{ ref('aspwks_integration__wks_pop6_kr_promotions') }}
),

sdl_pop6_tw_promotions as
(
	select * from {{ ref('aspwks_integration__wks_pop6_tw_promotions') }}
),

sdl_pop6_hk_promotions as
(
	select * from {{ ref('aspwks_integration__wks_pop6_hk_promotions') }}
),

sdl_pop6_jp_promotions as
(
	select * from {{ ref('aspwks_integration__wks_pop6_jp_promotions') }}
),

sdl_pop6_sg_promotions as
(
	select * from {{ ref('aspwks_integration__wks_pop6_sg_promotions') }}
),

sdl_pop6_th_promotions as
(
	select * from {{ ref('aspwks_integration__wks_pop6_th_promotions') }}
),
