...
final as (
    ...
    select
        ...
        coalesce(scale_qty, '') as scale_qty,
        cshdsc_bas,
        net_wgt_dl,
        ...
        coalesce(costcenter, '') as cost_center,
        ...
        coalesce(bill_rule, '') as bill_rule,
        ...
        coalesce(prov_group, '') as prov_grp,
        ...
        coalesce(salesdeal, '') as sls_deal,
