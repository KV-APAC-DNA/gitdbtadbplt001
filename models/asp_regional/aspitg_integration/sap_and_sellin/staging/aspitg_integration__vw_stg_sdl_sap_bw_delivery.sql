...
final as(
    select
        coalesce(deliv_numb,'') as deliv_numb,
        ...
        coalesce(volumeunit,'') as volumeunit,
        ...
        coalesce(st_up_dte,'') as st_up_dte,
        ...
        coalesce(ship_date,'') as ship_date,
        coalesce(goodsmv_st,'') as goodsmv_st,
        coalesce(sales_dist,'') as sales_dist,
        coalesce(gi_date,'') as gi_date,
        coalesce(act_gi_dte,'') as act_gi_dte,
