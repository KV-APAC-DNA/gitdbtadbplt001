    ...
    coalesce(suggestedclassificationscore::number(15,10),0) as suggestedclassificationscore ,
    ...
    coalesce(width::varchar(100),'') as width ,
    ...
    coalesce(material_number::varchar(500),'') as material_number ,
