...
final as(
    ...
    zactdldte::DATE as act_delv_dt,
    act_gi_dte::DATE as act_good_iss_dt,
    billtoprty::VARCHAR(10) as bill_to_prty,
    bill_date::DATE as bill_dt,
    ...
    zdelcrdat::DATE as delv_doc_crt_dt,
    distr_chan::VARCHAR(2) as dstr_chnl,
    division::VARCHAR(2) as div,
    createdon::DATE as doc_crt_dt,
    doc_date::DATE as doc_dt,
    gi_date::DATE as good_iss_dt,
    material::VARCHAR(18) as mat,
    matav_date::DATE as mat_avail_dt,
    ...
    zsd_pod::DATE as proof_delv_dt,
    zrcodekey::VARCHAR(29) as rsn_cd_key,
    reason_rej::VARCHAR(2) as rsn_rej,
    gt_cmfre::DATE as rlse_dt_cr_mgmt,
    zreq_date::DATE as rqst_delv_dt,
