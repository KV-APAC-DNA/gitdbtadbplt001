with wks_hcp_360_iqvia_brand_derma_temp as
(
    select * from {{ ref('hcpwks_integration__wks_hcp_360_iqvia_brand_derma_temp') }}
),
final as
(
    SELECT base.country,
    ...
    FROM wks_hcp_360_iqvia_brand_derma_temp base,
        (SELECT  country,
        source_system,
        brand,
        ...
        NoofPrescritions,
        NoofPrescribers
        FROM wks_hcp_360_iqvia_brand_derma_temp  
    ) derived
