...
FROM EDW_HCP360_KPI_RPT
WHERE upper(SOURCE_SYSTEM) =  'SFMC' AND EMAIL_ACTIVITY_TYPE = 'SENT'
GROUP BY 1,
         2,
         3,
         4,
...
FROM EDW_HCP360_KPI_RPT
WHERE upper(SOURCE_SYSTEM) =  'SFMC' AND EMAIL_ACTIVITY_TYPE = 'OPEN'
AND   IS_UNIQUE = 'Y'
GROUP BY 1,
         2,
         3,
...
FROM EDW_HCP360_KPI_RPT
WHERE upper(SOURCE_SYSTEM) =  'SFMC' AND EMAIL_ACTIVITY_TYPE = 'CLICK'
GROUP BY 1,
         2,
         3,
         4,
...
FROM EDW_HCP360_KPI_RPT
WHERE upper(SOURCE_SYSTEM) =  'SFMC' AND EMAIL_ACTIVITY_TYPE = 'UNSUBSCRIBE'
GROUP BY 1,
         2,
         3,
         4,
...
FROM EDW_HCP360_KPI_RPT
WHERE upper(SOURCE_SYSTEM) =  'SFMC' AND EMAIL_ACTIVITY_TYPE = 'FORWARD'
GROUP BY 1,
         2,
         3,
         4,
