...
(
    SELECT
      CASE 
        WHEN hostname IN ('www.orsl.in')
          THEN 'ORSL'
        WHEN hostname IN ('professional.johnsonsbaby.in')
          THEN 'JBABY'
        END AS BRAND,
      --left(date, 7) as year_month ,
      cal.cal_mo_1 AS year_month,
      cal.cal_wk as cal_week,
      hit_timestamp,
      visitnumber,
      visitid,
      fullvisitorid,
      ...
      eventlabel,
      eventvalue,
      product_detail_views_g3,
      store_locator_submits_g8,
      registration_start,
      page_type_cd2,
      site_section_cd3,
      sub_section_cd4,
      ...
      product_region_cd60,
      product_gfo_cd61,
      product_sub_brand_cd62,
      product_need_state_cd63,
      product_sub_category_cd64,
      product_segment_cd65,
      product_sub_segment_cd66,
      product_variant_cd67,
      pct_page_viewed_cm1,
      eretailer_exit_cm3,
      free_trial_request_cm4,
      video_play_cm6,
      video_time_played_cm7,
      video_segments_viewed_cm8,
      video_completes_cm9,
      where_to_buy_search_cm10,
      registration_cm17,
      log_in_cm18,
      log_out_cm19,
      coupon_click_cm20,
      coupon_print_cm21,
      coupon_print_error_cm22,
      coupon_value_cm23,
      coupon_rebate_cm24,
      product_rating_submit_cm26,
      product_rating_value_cm27,
      pdp_view_cm28,
      downloads_cm31,
      site_exit_cm32,
      social_share_cm34,
      page_engagement_cm37,
      listing_viewed_cm45,
      recommended_product_interaction_cm46,
      favorite_product_interaction_cm47,
      recommended_product_location_cm70,
      favorite_product_interaction_type_cm72,
      bounces,
      hits,
      new_visits,
      pageviews,
      ...
      'IN' AS country
    FROM itg_ga360_aspac_sessions src
    LEFT OUTER JOIN edw_calendar_dim cal ON src.DATE = cal.cal_day
    WHERE hostname IN ('www.orsl.in','professional.johnsonsbaby.in')  -- added as part of phase 2 in parameterization
      /*(
        SELECT parameter_value
        FROM hcp_log.log_query_parameters
        WHERE country_code = 'IN'
          AND parameter_name = 'hostname'
          AND parameter_type = 'GA360'
        )*/
),
final as
(
	...
	cal_week::varchar(25) as cal_week,
