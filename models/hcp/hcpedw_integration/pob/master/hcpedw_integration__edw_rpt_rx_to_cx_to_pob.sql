...
(
    ...
    latest_customer_code::varchar(100),
    latest_customer_name::varchar(100),
    latest_salesman_code::varchar(100),
    latest_salesman_name::varchar(100),
    latest_region::varchar(100),
    latest_zone::varchar(100),
    latest_territory::varchar(100),
    emp_hq_name::varchar(100),
    city::varchar(100),
    state::varchar(100),
    customer_type::varchar(100),
    core_noncore::varchar(100),
    is_active::varchar(1),
