...
(
    ...
    from (select distinct ci.*
		...
		,(select employee_key,employee_source_id,us.country_code ,o.organization_key,o.effective_from_date ,o.effective_to_date
			from edw_hcp360_veeva_dim_employee us,edw_hcp360_veeva_dim_organization o
			 where us.my_organization_code = o.my_organization_code (+)
			 and us.country_code = o.country_code (+) ) us_pr  
		, edw_vw_hcp360_date_dim dd            
		where ci.call_source_id = d.call_source_id (+) and ci.country_code = d.country_code (+)
