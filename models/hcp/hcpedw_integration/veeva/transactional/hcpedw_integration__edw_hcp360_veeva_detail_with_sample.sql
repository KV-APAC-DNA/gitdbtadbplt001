...
(
    ...
    from 
        (select c1.call_source_id, c1.parent_call_source_id ,c1.call_name parent_call_name,c1.attendees, c1.attendee_type, C1.CALL_NAME, c1.is_parent_call, hcp.hcp_key, c1.country_code, c1.call_source_id main_call_source_id
        ...
        ,( select child.call_source_id, child.parent_call_source_id, nvl(hco_key,'Not Applicable') hco_key, child.country_code
    ...
    convert_timezone('UTC',current_timestamp())::timestamp_ntz 
    from 
        (select c1.call_source_id, c1.parent_call_source_id , c1.call_name parent_call_name,c1.attendees,c1.attendee_type, C1.CALL_NAME, c1.is_parent_call, hco.hco_key, c1.country_code, c1.call_source_id main_call_source_id
            from itg_hcp360_veeva_call c1
                ,edw_hcp360_veeva_dim_hco hco 
            where (c1.parent_call_source_id is NULL or c1.parent_call_source_id = '')
        ...
        ,( select child.call_source_id, child.parent_call_source_id, nvl(hcp_key,'Not Applicable') hcp_key, child.country_code
            from  itg_hcp360_veeva_call child
                    ,edw_hcp360_veeva_dim_hcp hcp
