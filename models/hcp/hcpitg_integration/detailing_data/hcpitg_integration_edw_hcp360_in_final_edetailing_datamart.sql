...
detailing_va_hcp_jn as (
    select * from   {{ ref('hcpitg_integration_itg_hcp360_in_detailing_va_hcp_join') }}
),

region_filter_hcp as (
    select *
    from {{ ref('hcpitg_integration_itg_hcp360_in_region_filter_hcp') }}
),

dcr_hcp_region_join as (
    select *
    from {{ ref('hcpitg_integration_itg_hcp360_in_dcr_hcp_region_join') }}
),
