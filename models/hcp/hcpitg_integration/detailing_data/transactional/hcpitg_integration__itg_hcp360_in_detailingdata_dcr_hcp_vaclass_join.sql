...
detailing_data AS (
    SELECT * FROM DEV_DNA_CORE.hcpitg_integration.SDL_HCP360_IN_VENTASYS_EDETAILING_RAW
),

va_class AS (
    SELECT * FROM DEV_DNA_CORE.hcpitg_integration.SDL_HCP360_IN_VENTASYS_VA_PAGE_RAW
),
